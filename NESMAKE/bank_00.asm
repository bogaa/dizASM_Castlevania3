    ...
    loadPlayerCHRBank: LDY.W wEntityObjectIdxes             ;008001|AC4E05  |00054E;
                       LDA.W playerCHRBankdata,Y            ;008004|B90F80  |00800F;
                       STA.B wChrBankSpr_0000               ;008007|8546    |000046;
                       CLC                                  ;008009|18      |      ;
                       ADC.B #$01                           ;00800A|6901    |      ;
 
                       STA.B wChrBankSpr_0400               ;00800C|8547    |000047;
                       RTS                                  ;00800E|60      |      ;
 
 
    playerCHRBankdata: db $00,$04,$02,$06                   ;00800F|        |      ;
 
 getCurrRoomsChrBanks: LDA.B wCurrRoomGroupStage            ;008013|A532    |000032;
                       ASL A                                ;008015|0A      |      ;
                       TAY                                  ;008016|A8      |      ;
                       LDA.W roomCHRbanks,Y                 ;008017|B96680  |008066;
                       STA.B wCurrNumToVramQueue            ;00801A|8508    |000008;
                       LDA.W PTR16_008067,Y                 ;00801C|B96780  |008067;
                       STA.B $09                            ;00801F|8509    |000009;
                       LDA.B wCurrRoomSectionBlock          ;008021|A533    |000033;
                       ASL A                                ;008023|0A      |      ;
                       ASL A                                ;008024|0A      |      ;
                       STA.B wRoomSectionChrBanksDataOffset ;008025|850F    |00000F;
                       TAY                                  ;008027|A8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;008028|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00802A|850A    |00000A;
                       INY                                  ;00802C|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00802D|B108    |000008;
                       STA.B $0B                            ;00802F|850B    |00000B;
                       LDA.B wCurrRoomIdx                   ;008031|A534    |000034;
                       ASL A                                ;008033|0A      |      ;
                       CLC                                  ;008034|18      |      ;
                       ADC.B wCurrRoomIdx                   ;008035|6534    |000034;
                       TAY                                  ;008037|A8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;008038|B10A    |00000A;
                       STA.B wChrBankBG_0400                ;00803A|854B    |00004B;
                       INY                                  ;00803C|C8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00803D|B10A    |00000A;
                       STA.B wChrBankBG_0800                ;00803F|854C    |00004C;
                       INY                                  ;008041|C8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;008042|B10A    |00000A;
                       STA.B wChrBankSecondQuest_1400       ;008044|854E    |00004E;
                       LDY.B wRoomSectionChrBanksDataOffset ;008046|A40F    |00000F;
                       INY                                  ;008048|C8      |      ;
                       INY                                  ;008049|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00804A|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00804C|850A    |00000A;
                       INY                                  ;00804E|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00804F|B108    |000008;
                       STA.B $0B                            ;008051|850B    |00000B;
                       LDA.B wCurrRoomIdx                   ;008053|A534    |000034;
 
                       ASL A                                ;008055|0A      |      ;
                       TAY                                  ;008056|A8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;008057|B10A    |00000A;
                       STA.B wChrBankSpr_0800               ;008059|8548    |000048;
                       INY                                  ;00805B|C8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00805C|B10A    |00000A;
                       STA.B wChrBankSpr_0c00               ;00805E|8549    |000049;
                       db $20                               ;008060|        |      ;
       ...
       chrGroupData03: db $48,$47,$36                       ;008199|        |      ;
         ...
         DATA8_0083EA: db $61,$62,$61,$62,$A2               ;0083EA|        |      ;
                       ...
                       LDA.B wChrBankBG_0800                ;0083F7|A54C    |00004C;
                       ...
                       STA.B wCurrNumToVramQueue            ;008413|8508    |000008;
                       LDA.W PTR16_00843E,Y                 ;008415|B93E84  |00843E;
 
          CODE_008418: STA.B $09                            ;008418|8509    |000009;
                       LDY.B #$00                           ;00841A|A000    |      ;
 
          CODE_00841C: LDA.B (wCurrNumToVramQueue),Y        ;00841C|B108    |000008;
                       INY                                  ;00841E|C8      |      ;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00841F|850A    |00000A;
 
                       LDA.B (wCurrNumToVramQueue),Y        ;008421|B108    |000008;
                       INY                                  ;008423|C8      |      ;
 
          CODE_008424: STA.W wCurrChrBanksTileCollisionTypeOffsets,X;008424|9D7007  |000770;
                       INX                                  ;008427|E8      |      ;
                       DEC.B wCurrRoomSectionPlayerPosAndScreenAddr;008428|C60A    |00000A;
          ...
          CODE_008432: LDA.W PTR16_008493,Y                 ;008432|B99384  |008493;
                       STA.B wCurrNumToVramQueue            ;008435|8508    |000008;
         ...
         DATA8_0084FD: db $06,$B8,$02,$C0                   ;0084FD|        |      ;
          ...
          CODE_008501: LDA.B wCurrRoomGroupStage            ;008501|A532    |000032;
                       CMP.B #$0C                           ;008503|C90C    |      ;
 
                       BNE CODE_00850E                      ;008505|D007    |00850E;
                       LDY.W wHardMode                      ;008507|ACF607  |0007F6;
          ...
          CODE_00850E: ASL A                                ;00850E|0A      |      ;
                       ...
                       STA.B wCurrNumToVramQueue            ;008513|8508    |000008;
                       LDA.W PTR16_0085CE,Y                 ;008515|B9CE85  |0085CE;
                       STA.B $09                            ;008518|8509    |000009;
                       LDA.B wCurrRoomSectionBlock          ;00851A|A533    |000033;
                       ASL A                                ;00851C|0A      |      ;
                       ASL A                                ;00851D|0A      |      ;
                       TAY                                  ;00851E|A8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00851F|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;008521|850A    |00000A;
                       INY                                  ;008523|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;008524|B108    |000008;
                       STA.B $0B                            ;008526|850B    |00000B;
 
                       INY                                  ;008528|C8      |      ;
                       STY.B wDoubleCurrRoomIdx             ;008529|840E    |00000E;
                       RTS                                  ;00852B|60      |      ;
          ...
          CODE_00852C: LDA.B #$09                           ;00852C|A909    |      ;
                       ...
                       LDY.B wCurrRoomIdx                   ;008538|A434    |000034;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00853A|B10A    |00000A;
          ...
          CODE_008544: STA.B $00                            ;008544|8500    |000000;
                       ...
                       TAY                                  ;00854C|A8      |      ;
                       LDX.B wVramQueueNextIdxToFill        ;00854D|A61D    |00001D;
                       LDA.B #$03                           ;00854F|A903    |      ;
                       STA.B wDoubleCurrSection             ;008551|850D    |00000D;
 
          CODE_008553: LDA.B #$03                           ;008553|A903    |      ;
                       STA.B wDoubleCurrGroup               ;008555|850C    |00000C;
          ...
          CODE_00855E: STA.W $02F4,X                        ;00855E|9DF402  |0002F4;
                       ...
                       INY                                  ;008561|C8      |      ;
                       INX                                  ;008562|E8      |      ;
                       DEC.B wDoubleCurrGroup               ;008563|C60C    |00000C;
                       BNE CODE_008557                      ;008565|D0F0    |008557;
                       INX                                  ;008567|E8      |      ;
 
                       DEC.B wDoubleCurrSection             ;008568|C60D    |00000D;
          ...
          CODE_008574: JSR.W CODE_0085BB                    ;008574|20BB85  |0085BB;
                       LDY.B wDoubleCurrRoomIdx             ;008577|A40E    |00000E;
                       LDA.B (wCurrNumToVramQueue),Y        ;008579|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00857B|850A    |00000A;
                       INY                                  ;00857D|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00857E|B108    |000008;
                       STA.B $0B                            ;008580|850B    |00000B;
                       LDY.B wCurrRoomIdx                   ;008582|A434    |000034;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;008584|B10A    |00000A;
                       ASL A                                ;008586|0A      |      ;
                       CLC                                  ;008587|18      |      ;
                       ADC.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;008588|710A    |00000A;
                       TAY                                  ;00858A|A8      |      ;
                       LDX.B wVramQueueNextIdxToFill        ;00858B|A61D    |00001D;
                       LDA.B #$03                           ;00858D|A903    |      ;
                       STA.B wDoubleCurrGroup               ;00858F|850C    |00000C;
 
          CODE_008591: LDA.W DATA8_0089CE,Y                 ;008591|B9CE89  |0089CE;
                       STA.W $02F0,X                        ;008594|9DF002  |0002F0;
                       INY                                  ;008597|C8      |      ;
                       INX                                  ;008598|E8      |      ;
                       DEC.B wDoubleCurrGroup               ;008599|C60C    |00000C;
          ...
          CODE_0085A4: JSR.W CODE_00859E                    ;0085A4|209E85  |00859E;
                       LDX.B wVramQueueNextIdxToFill        ;0085A7|A61D    |00001D;
         ...
         DATA8_0085B8: db $20,$26,$37                       ;0085B8|        |      ;
          ...
          CODE_0085BB: LDY.W wEntityObjectIdxes             ;0085BB|AC4E05  |00054E;
   ...
   PAL_sprite_alucart: db $10,$3F,$0F,$0F,$15               ;0089BB|        |      ;
         ...
         DATA8_008B29: db $A9,$58,$8D,$38,$04               ;008B29|        |      ;
          ...
          CODE_008B8A: LDA.W PTR16_008BD1,Y                 ;008B8A|B9D18B  |008BD1;
                       STA.B wCurrDrawnEntityCachedAttr     ;008B8D|8510    |000010;
                       LDA.W PTR16_008BD2,Y                 ;008B8F|B9D28B  |008BD2;
                       STA.B wCollisionPointYinScreen       ;008B92|8511    |000011;
                       LDY.B $B4                            ;008B94|A4B4    |0000B4;
                       LDA.B (wCurrDrawnEntityCachedAttr),Y ;008B96|B110    |000010;
                       CMP.B #$FF                           ;008B98|C9FF    |      ;
                       BEQ CODE_008B7C                      ;008B9A|F0E0    |008B7C;
 
          CODE_008B9C: STA.B wCollisionPointXvalDiv32       ;008B9C|8512    |000012;
          ...
          CODE_008BA2: LDA.B #$02                           ;008BA2|A902    |      ;
                       ...
                       LDA.B w015                           ;008BA6|A515    |000015;
 
          CODE_008BA8: CLC                                  ;008BA8|18      |      ;
                       ADC.B #$04                           ;008BA9|6904    |      ;
                       TAX                                  ;008BAB|AA      |      ;
                       LDA.B #$04                           ;008BAC|A904    |      ;
                       STA.B wCollisionPointAbsoluteXInRoom ;008BAE|8513    |000013;
 
          CODE_008BB0: LDA.B #$03                           ;008BB0|A903    |      ;
                       STA.B wCollisionPointAbsoluteXRoom   ;008BB2|8514    |000014;
 
          CODE_008BB4: LDA.W wVramQueue,X                   ;008BB4|BD0003  |000300;
 
          CODE_008BB7: CLC                                  ;008BB7|18      |      ;
                       ADC.B wCollisionPointXvalDiv32       ;008BB8|6512    |000012;
                       BPL CODE_008BBE                      ;008BBA|1002    |008BBE;
                       LDA.B #$0F                           ;008BBC|A90F    |      ;
 
          CODE_008BBE: STA.W wVramQueue,X                   ;008BBE|9D0003  |000300;
                       INX                                  ;008BC1|E8      |      ;
                       DEC.B wCollisionPointAbsoluteXRoom   ;008BC2|C614    |000014;
                       BNE CODE_008BB4                      ;008BC4|D0EE    |008BB4;
                       INX                                  ;008BC6|E8      |      ;
                       DEC.B wCollisionPointAbsoluteXInRoom ;008BC7|C613    |000013;
         ...
         DATA8_008BDC: db $00,$00,$F0,$E0,$D0               ;008BDC|        |      ;
          ...
          CODE_008BEC: LDA.W wCurrScore,Y                   ;008BEC|B93600  |000036;
 
                       JSR.W CODE_008C6D                    ;008BEF|206D8C  |008C6D;
                       STA.W wCurrScore,Y                   ;008BF2|993600  |000036;
                       INY                                  ;008BF5|C8      |      ;
                       INX                                  ;008BF6|E8      |      ;
                       ...
                       STA.B wCurrScore                     ;008BFF|8536    |000036;
          ...
          CODE_008C2E: RTS                                  ;008C2E|60      |      ;
                       ...
                       LDA.B wNumHearts                     ;008C31|A584    |000084;
                       AND.B #$0F                           ;008C33|290F    |      ;
                       STA.B $01                            ;008C35|8501    |000001;
                       LDA.B wNumHearts                     ;008C37|A584    |000084;
          ...
          CODE_008C54: ORA.B $02                            ;008C54|0502    |000002;
                       ...
                       STA.B wNumHearts                     ;008C56|8584    |000084;
                       RTS                                  ;008C58|60      |      ;
 
                       LDA.B wNumHearts                     ;008C59|A584    |000084;
                       CLC                                  ;008C5B|18      |      ;
                       JSR.W CODE_008C69                    ;008C5C|20698C  |008C69;
                       BCS CODE_008C64                      ;008C5F|B003    |008C64;
                       STA.B wNumHearts                     ;008C61|8584    |000084;
                       RTS                                  ;008C63|60      |      ;
 
 
          CODE_008C64: LDA.B #$99                           ;008C64|A999    |      ;
                       STA.B wNumHearts                     ;008C66|8584    |000084;
                       RTS                                  ;008C68|60      |      ;
          ...
          CODE_008C97: LDA.B #$20                           ;008C97|A920    |      ;
                       ...
                       STA.B wVramQueueDest                 ;008C9D|8561    |000061;
                       LDA.B wNumHearts                     ;008C9F|A584    |000084;
                       STA.B wCurrNumToVramQueue            ;008CA1|8508    |000008;
                       db $4C                               ;008CA3|        |      ;
          ...
          CODE_008CA6: LDA.B #$20                           ;008CA6|A920    |      ;
                       ...
                       STA.B wVramQueueDest                 ;008CAC|8561    |000061;
                       LDA.B wPlayerHealth                  ;008CAE|A53C    |00003C;
                       STA.B wCurrNumToVramQueue            ;008CB0|8508    |000008;
                       LDA.B #$83                           ;008CB2|A983    |      ;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;008CB4|850A    |00000A;
                       ...
                       STA.B wVramQueueDest                 ;008CC3|8561    |000061;
                       LDA.B wBossHealth                    ;008CC5|A53D    |00003D;
                       STA.B wCurrNumToVramQueue            ;008CC7|8508    |000008;
 
                       LDA.B #$93                           ;008CC9|A993    |      ;
 
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;008CCB|850A    |00000A;
         ...
         DATA8_008CD1: db $20                               ;008CD1|        |      ;
          ...
          CODE_008CD8: LDA.B wCurrNumToVramQueue            ;008CD8|A508    |000008;
                       BEQ CODE_008D0D                      ;008CDA|F031    |008D0D;
                       CMP.B #$08                           ;008CDC|C908    |      ;
                       BCC CODE_008CF3                      ;008CDE|9013    |008CF3;
                       LDA.B wCurrRoomSectionPlayerPosAndScreenAddr;008CE0|A50A    |00000A;
                       STA.W wVramQueue,X                   ;008CE2|9D0003  |000300;
 
                       INX                                  ;008CE5|E8      |      ;
                       LDA.B wCurrNumToVramQueue            ;008CE6|A508    |000008;
                       SEC                                  ;008CE8|38      |      ;
                       SBC.B #$08                           ;008CE9|E908    |      ;
                       STA.B wCurrNumToVramQueue            ;008CEB|8508    |000008;
          ...
          CODE_008CF3: CMP.B #$05                           ;008CF3|C905    |      ;
                       ...
                       STA.W wVramQueue,X                   ;008CF9|9D0003  |000300;
                       INX                                  ;008CFC|E8      |      ;
                       DEC.B $09                            ;008CFD|C609    |000009;
                       BEQ CODE_008D18                      ;008CFF|F017    |008D18;
                       BNE CODE_008D0D                      ;008D01|D00A    |008D0D;
 
          CODE_008D03: LDA.B wCurrRoomSectionPlayerPosAndScreenAddr;008D03|A50A    |00000A;
                       STA.W wVramQueue,X                   ;008D05|9D0003  |000300;
                       INX                                  ;008D08|E8      |      ;
          ...
          CODE_008D11: STA.W wVramQueue,X                   ;008D11|9D0003  |000300;
                       INX                                  ;008D14|E8      |      ;
                       DEY                                  ;008D15|88      |      ;
                       BNE CODE_008D11                      ;008D16|D0F9    |008D11;
 
          CODE_008D18: LDA.B #$FF                           ;008D18|A9FF    |      ;
                       STA.W wVramQueue,X                   ;008D1A|9D0003  |000300;
                       INX                                  ;008D1D|E8      |      ;
                       STX.B wVramQueueNextIdxToFill        ;008D1E|861D    |00001D;
                       RTS                                  ;008D20|60      |      ;
          ...
          CODE_008D21: LDA.B #$20                           ;008D21|A920    |      ;
                       ...
                       STA.B wVramQueueDest                 ;008D27|8561    |000061;
                       LDA.B $7F                            ;008D29|A57F    |00007F;
                       STA.B wCurrNumToVramQueue            ;008D2B|8508    |000008;
                       db $20                               ;008D2D|        |      ;
                       dw UNREACH_0FE8FC                    ;008D2E|        |0FE8FC;
 
                       INC.B wVramQueueDest                 ;008D30|E661    |000061;
                       INC.B wVramQueueDest                 ;008D32|E661    |000061;
                       LDA.B wCurrTimeLeft                  ;008D34|A57E    |00007E;
                       STA.B wCurrNumToVramQueue            ;008D36|8508    |000008;
                       db $4C                               ;008D38|        |      ;
          ...
          CODE_008D3B: LDA.B #$20                           ;008D3B|A920    |      ;
                       ...
                       STA.B wVramQueueDest                 ;008D41|8561    |000061;
                       LDA.B $38                            ;008D43|A538    |000038;
                       STA.B wCurrNumToVramQueue            ;008D45|8508    |000008;
                       db $20                               ;008D47|        |      ;
                       dw UNREACH_0FE8FC                    ;008D48|        |0FE8FC;
                       INC.B wVramQueueDest                 ;008D4A|E661    |000061;
                       INC.B wVramQueueDest                 ;008D4C|E661    |000061;
                       LDA.B $37                            ;008D4E|A537    |000037;
                       STA.B wCurrNumToVramQueue            ;008D50|8508    |000008;
                       db $20                               ;008D52|        |      ;
                       dw UNREACH_0FE8FC                    ;008D53|        |0FE8FC;
                       INC.B wVramQueueDest                 ;008D55|E661    |000061;
                       INC.B wVramQueueDest                 ;008D57|E661    |000061;
                       LDA.B wCurrScore                     ;008D59|A536    |000036;
                       STA.B wCurrNumToVramQueue            ;008D5B|8508    |000008;
                       db $4C                               ;008D5D|        |      ;
          ...
          CODE_008D66: JSR.W CODE_008D60                    ;008D66|20608D  |008D60;
                       ...
                       LDX.B wRoomOrientation               ;008D88|A668    |000068;
          ...
          CODE_008D96: LDA.B wCurrRoomGroupStage            ;008D96|A532    |000032;
                       ASL A                                ;008D98|0A      |      ;
                       TAY                                  ;008D99|A8      |      ;
                       LDA.W PTR16_008DCF,Y                 ;008D9A|B9CF8D  |008DCF;
                       STA.B wCurrNumToVramQueue            ;008D9D|8508    |000008;
                       ...
                       STA.B wVramQueueDest                 ;008DAA|8561    |000061;
                       db $20                               ;008DAC|        |      ;
                       dw CODE_0FE8B5                       ;008DAD|        |0FE8B5;
                       LDY.B #$00                           ;008DAF|A000    |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;008DB1|B108    |000008;
                       STA.W wVramQueue,X                   ;008DB3|9D0003  |000300;
                       db $20                               ;008DB6|        |      ;
                       ...
                       STA.B wVramQueueDest                 ;008DBF|8561    |000061;
                       db $20                               ;008DC1|        |      ;
                       dw CODE_0FE8B5                       ;008DC2|        |0FE8B5;
 
                       LDY.B wCurrRoomSectionBlock          ;008DC4|A433    |000033;
                       INY                                  ;008DC6|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;008DC7|B108    |000008;
                       STA.W wVramQueue,X                   ;008DC9|9D0003  |000300;
                       db $4C                               ;008DCC|        |      ;
         ...
         DATA8_008E38: db $50,$42,$43,$44                   ;008E38|        |      ;
          ...
          CODE_008E3C: LDA.B #$20                           ;008E3C|A920    |      ;
                       ...
                       STA.B wVramQueueDest                 ;008E42|8561    |000061;
                       LDY.B wCurrLivesLeft                 ;008E44|A435    |000035;
                       STY.B wCurrNumToVramQueue            ;008E46|8408    |000008;
                       db $4C                               ;008E48|        |      ;
 
                       dw UNREACH_0FE8FC                    ;008E49|        |0FE8FC;
 
          CODE_008E4B: LDA.B wCurrCharacterIdx              ;008E4B|A53B    |00003B;
                       EOR.B #$01                           ;008E4D|4901    |      ;
                       TAY                                  ;008E4F|A8      |      ;
                       LDA.W wUsableChars,Y                 ;008E50|B93900  |000039;
         ...
         DATA8_008E5D: db $0F,$10,$11,$12                   ;008E5D|        |      ;
          ...
          CODE_008E61: JSR.W CODE_008E92                    ;008E61|20928E  |008E92;
                       LDY.B wCurrCharacterIdx              ;008E64|A43B    |00003B;
 
                       LDA.W wSubWeaponMultiplier,Y         ;008E66|B98700  |000087;
                       ASL A                                ;008E69|0A      |      ;
                       TAY                                  ;008E6A|A8      |      ;
                       ...
                       LDX.B wRoomOrientation               ;008E87|A668    |000068;
          ...
          CODE_008E92: LDY.B wCurrCharacterIdx              ;008E92|A43B    |00003B;
                       LDA.W wCurrSubweapon,Y               ;008E94|B98500  |000085;
                       ASL A                                ;008E97|0A      |      ;
                       ASL A                                ;008E98|0A      |      ;
                       CLC                                  ;008E99|18      |      ;
                       ADC.W wCurrSubweapon,Y               ;008E9A|798500  |000085;
                       TAY                                  ;008E9D|A8      |      ;
                       ...
                       LDX.B wRoomOrientation               ;008EB3|A668    |000068;
         ...
         DATA8_008ED3: db $00,$46,$00,$90,$24               ;008ED3|        |      ;
          ...
          CODE_008F0B: LDA.B wRosseryFlashTimer             ;008F0B|A5B2    |0000B2;
                       BEQ CODE_008F35                      ;008F0D|F026    |008F35;
                       DEC.B wRosseryFlashTimer             ;008F0F|C6B2    |0000B2;
                       BEQ CODE_008F19                      ;008F11|F006    |008F19;
                       LDA.B wRosseryFlashTimer             ;008F13|A5B2    |0000B2;
          ...
          CODE_008F1F: JSR.W CODE_00859E                    ;008F1F|209E85  |00859E;
                       ...
                       LDX.B wVramQueueNextIdxToFill        ;008F22|A61D    |00001D;
          ...
          CODE_008F35: LDA.B wPotionTimer                   ;008F35|A5AD    |0000AD;
                       BEQ CODE_008F4E                      ;008F37|F015    |008F4E;
                       LDA.B wGameStateLoopCounter          ;008F39|A51A    |00001A;
                       AND.B #$01                           ;008F3B|2901    |      ;
                       BEQ CODE_008F43                      ;008F3D|F004    |008F43;
                       DEC.B wPotionTimer                   ;008F3F|C6AD    |0000AD;
                       BEQ CODE_008F19                      ;008F41|F0D6    |008F19;
 
          CODE_008F43: LDA.B wPotionTimer                   ;008F43|A5AD    |0000AD;
          ...
          CODE_008F4E: LDA.B wGameStateLoopCounter          ;008F4E|A51A    |00001A;
          ...
          CODE_008F77: STA.W $5FC0,Y                        ;008F77|99C05F  |005FC0;
                       ...
                       STA.B wCurrScore                     ;008F85|8536    |000036;
                       STA.B $37                            ;008F87|8537    |000037;
                       STA.B $38                            ;008F89|8538    |000038;
                       LDY.B wCheckpoint                    ;008F8B|A42E    |00002E;
                       LDA.W DATA8_008F9E,Y                 ;008F8D|B99E8F  |008F9E;
                       AND.B #$0F                           ;008F90|290F    |      ;
 
                       STA.B wCurrRoomSectionBlock          ;008F92|8533    |000033;
                       ...
                       LSR A                                ;008F99|4A      |      ;
                       LSR A                                ;008F9A|4A      |      ;
                       STA.B wCurrRoomGroupStage            ;008F9B|8532    |000032;
                       RTS                                  ;008F9D|60      |      ;
         ...
         DATA8_008F9E: db $00,$10,$13,$20,$21               ;008F9E|        |      ;
          ...
          CODE_008FB0: LDA.B wCurrRoomGroupStage            ;008FB0|A532    |000032;
                       ASL A                                ;008FB2|0A      |      ;
                       CLC                                  ;008FB3|18      |      ;
                       ADC.B wCurrRoomGroupStage            ;008FB4|6532    |000032;
                       TAY                                  ;008FB6|A8      |      ;
                       LDA.W DATA8_008FD1,Y                 ;008FB7|B9D18F  |008FD1;
                       CMP.B wCurrRoomSectionBlock          ;008FBA|C533    |000033;
          ...
          CODE_008FC6: STA.B wCheckpoint                    ;008FC6|852E    |00002E;
                       RTS                                  ;008FC8|60      |      ;
 
 
          CODE_008FC9: LDY.B wGrantDefeated                 ;008FC9|A42F    |00002F;
         ...
         DATA8_008FD2: db $00,$00,$02,$01,$02               ;008FD2|        |      ;
          ...
          CODE_009031: LDA.W DATA8_00904D,Y                 ;009031|B94D90  |00904D;
                       ...
                       STA.B wCurrNumToVramQueue            ;009034|8508    |000008;
          ...
          CODE_00903D: LDA.W $07F8,Y                        ;00903D|B9F807  |0007F8;
                       CMP.B (wCurrNumToVramQueue),Y        ;009040|D108    |000008;
         ...
         DATA8_00904E: db $90,$5F,$90,$67,$90               ;00904E|        |      ;
          ...
          CODE_00907F: LDA.B #$B0                           ;00907F|A9B0    |      ;
                       ...
                       LDA.B wPartnerIdx                    ;009098|A53A    |00003A;
          ...
          CODE_0090AE: STA.B wPartnerIdx                    ;0090AE|853A    |00003A;
                       BNE CODE_0090B7                      ;0090B0|D005    |0090B7;
 
          CODE_0090B2: LDA.B #$01                           ;0090B2|A901    |      ;
                       STA.W wHardMode                      ;0090B4|8DF607  |0007F6;
 
          CODE_0090B7: LDA.B #$02                           ;0090B7|A902    |      ;
 
          CODE_0090B9: STA.B wCurrLivesLeft                 ;0090B9|8535    |000035;
          ...
          CODE_0090C0: LDA.B #$05                           ;0090C0|A905    |      ;
                       STA.B wNumHearts                     ;0090C2|8584    |000084;
                       LDA.B #$40                           ;0090C4|A940    |      ;
                       STA.B wPlayerHealth                  ;0090C6|853C    |00003C;
 
          CODE_0090C8: LDA.B #$40                           ;0090C8|A940    |      ;
                       STA.B wBossHealth                    ;0090CA|853D    |00003D;
                       RTS                                  ;0090CC|60      |      ;
 
 
          CODE_0090CD: LDA.B #$40                           ;0090CD|A940    |      ;
                       STA.B wChrBankBG_0000                ;0090CF|854A    |00004A;
                       LDA.B #$43                           ;0090D1|A943    |      ;
                       STA.B wChrBankBG_0c00                ;0090D3|854D    |00004D;
                       RTS                                  ;0090D5|60      |      ;
 
 
          CODE_0090D6: LDA.B #$00                           ;0090D6|A900    |      ;
                       STA.B wStopWatchActive               ;0090D8|85AB    |0000AB;
                       STA.B wStopWatchTimer                ;0090DA|85AC    |0000AC;
                       STA.W $06C9                          ;0090DC|8DC906  |0006C9;
                       STA.B wBridgeTimer                   ;0090DF|85B3    |0000B3;
                       RTS                                  ;0090E1|60      |      ;
 
                       LDA.B #$B0                           ;0090E2|A9B0    |      ;
                       STA.B wPPUCtrl                       ;0090E4|85FF    |0000FF;
                       db $20                               ;0090E6|        |      ;
                       dw UNREACH_0FE666                    ;0090E7|        |0FE666;
                       JSR.W CODE_0090C8                    ;0090E9|20C890  |0090C8;
                       LDA.B #$00                           ;0090EC|A900    |      ;
                       STA.W wOamSpecIdxDoubled             ;0090EE|8D0004  |000400;
                       STA.W $0418                          ;0090F1|8D1804  |000418;
                       STA.W $0419                          ;0090F4|8D1904  |000419;
                       STA.B wMusicLoaded                   ;0090F7|8574    |000074;
                       STA.B $75                            ;0090F9|8575    |000075;
                       STA.W wPlayerStateDoubled            ;0090FB|8D6505  |000565;
                       ...
                       STA.W wEntityYposSpeed               ;009109|8D2005  |000520;
                       STA.W wEntityYposSubSpeed            ;00910C|8D3705  |000537;
                       JSR.W CODE_0090D6                    ;00910F|20D690  |0090D6;
                       db $20                               ;009112|        |      ;
                       dw CODE_0FE862                       ;009113|        |0FE862;
                       BCS CODE_009130                      ;009115|B019    |009130;
                       LDA.W wInstrumentsSoundIdxes         ;009117|AD0701  |000107;
                       CMP.B #$5F                           ;00911A|C95F    |      ;
                       BNE CODE_009122                      ;00911C|D004    |009122;
                       LDA.B #$00                           ;00911E|A900    |      ;
                       STA.B wMusicLoaded                   ;009120|8574    |000074;
 
          CODE_009122: LDA.B #$B0                           ;009122|A9B0    |      ;
                       STA.B wPPUCtrl                       ;009124|85FF    |0000FF;
                       db $20                               ;009126|        |      ;
          ...
          CODE_009130: JSR.W CODE_0090CD                    ;009130|20CD90  |0090CD;
                       ...
                       STA.B wPPUCtrl                       ;009135|85FF    |0000FF;
                       LDA.W wPlayerStateDoubled            ;009137|AD6505  |000565;
                       AND.B #$7F                           ;00913A|297F    |      ;
                       STA.W wPlayerStateDoubled            ;00913C|8D6505  |000565;
                       LDA.B #$00                           ;00913F|A900    |      ;
                       STA.B $78                            ;009141|8578    |000078;
                       STA.B wHurtInvincibilityFrames       ;009143|8580    |000080;
                       STA.B wLoadCHRbeforeSwap             ;009145|85B0    |0000B0;
                       STA.B wRosseryFlashTimer             ;009147|85B2    |0000B2;
                       STA.B wPotionTimer                   ;009149|85AD    |0000AD;
                       STA.B wCinematicsControllerBossDefeated;00914B|852C    |00002C;
                       STA.B wFloodStop                     ;00914D|85C0    |0000C0;
                       STA.B wBossSecondFace                ;00914F|85C2    |0000C2;
                       STA.B wHorizontalScrollLockBridge    ;009151|85C8    |0000C8;
                       STA.B wBossObject                    ;009153|85C1    |0000C1;
                       STA.B wDisablePlayer                 ;009155|85C4    |0000C4;
                       STA.B $C5                            ;009157|85C5    |0000C5;
                       STA.B $CC                            ;009159|85CC    |0000CC;
                       STA.B $CD                            ;00915B|85CD    |0000CD;
                       STA.B wBossSpecialHitbox             ;00915D|85BA    |0000BA;
                       db $20                               ;00915F|        |      ;
          ...
          CODE_009176: STA.W wSoundModeSongSelected,X       ;009176|9D8007  |000780;
                       INX                                  ;009179|E8      |      ;
          ...
          CODE_009182: STA.W wCurrCollisionMapValues90,X    ;009182|9DE006  |0006E0;
                       INX                                  ;009185|E8      |      ;
          ...
          CODE_00918B: LDA.B #$B0                           ;00918B|A9B0    |      ;
                       STA.B wPPUCtrl                       ;00918D|85FF    |0000FF;
                       db $20                               ;00918F|        |      ;
                       dw UNREACH_0FE666                    ;009190|        |0FE666;
                       JSR.W CODE_0090CD                    ;009192|20CD90  |0090CD;
                       db $20                               ;009195|        |      ;
                       dw UNREACH_0FE5CA                    ;009196|        |0FE5CA;
                       LDA.W wEntityObjectIdxes             ;009198|AD4E05  |00054E;
                       PHA                                  ;00919B|48      |      ;
                       LDA.B wBossDragonKingHP              ;00919C|A5BD    |0000BD;
 
                       PHA                                  ;00919E|48      |      ;
                       LDA.B wBossDragonMisc                ;00919F|A5BE    |0000BE;
                       PHA                                  ;0091A1|48      |      ;
                       db $20                               ;0091A2|        |      ;
 
                       dw clearZeroPage                     ;0091A3|        |0FE828;
                       PLA                                  ;0091A5|68      |      ;
                       STA.B wBossDragonMisc                ;0091A6|85BE    |0000BE;
                       PLA                                  ;0091A8|68      |      ;
                       STA.B wBossDragonKingHP              ;0091A9|85BD    |0000BD;
 
                       PLA                                  ;0091AB|68      |      ;
                       STA.W wEntityObjectIdxes             ;0091AC|8D4E05  |00054E;
                       JMP.W CODE_0090C0                    ;0091AF|4CC090  |0090C0;
 
                       LDA.B #$00                           ;0091B2|A900    |      ;
                       STA.B wHurtInvincibilityFrames       ;0091B4|8580    |000080;
                       STA.W wEntityState                   ;0091B6|8D7004  |000470;
                       DEC.B wGenericStateTimer             ;0091B9|C630    |000030;
                       BNE CODE_0091CD                      ;0091BB|D010    |0091CD;
                       LDA.B $9F                            ;0091BD|A59F    |00009F;
                       STA.B wInGameSubstate                ;0091BF|852A    |00002A;
                       LDA.W wPlayerStateDoubled            ;0091C1|AD6505  |000565;
                       AND.B #$7F                           ;0091C4|297F    |      ;
                       STA.W wPlayerStateDoubled            ;0091C6|8D6505  |000565;
                       LDA.B #$00                           ;0091C9|A900    |      ;
                       BEQ CODE_0091D1                      ;0091CB|F004    |0091D1;
 
          CODE_0091CD: LDA.B wGameStateLoopCounter          ;0091CD|A51A    |00001A;
                       AND.B #$03                           ;0091CF|2903    |      ;
 
          CODE_0091D1: STA.W wEntityPaletteOverride         ;0091D1|8D5404  |000454;
                       RTS                                  ;0091D4|60      |      ;
 
                       JSR.W DATA8_0091DD                   ;0091D5|20DD91  |0091DD;
                       LDA.B #$00                           ;0091D8|A900    |      ;
                       STA.B wInGameSubstate                ;0091DA|852A    |00002A;
                       RTS                                  ;0091DC|60      |      ;
 
 
         DATA8_0091DD: db $20                               ;0091DD|        |      ;
                       dw UNREACH_0FE795                    ;0091DE|        |0FE795;
                       LDA.B wCurrRoomGroupStage            ;0091E0|A532    |000032;
          ...
          CODE_0091F1: LDA.B #$00                           ;0091F1|A900    |      ;
                       STA.W wPlayerStateDoubled            ;0091F3|8D6505  |000565;
                       STA.B $75                            ;0091F6|8575    |000075;
                       STA.B wMusicLoaded                   ;0091F8|8574    |000074;
                       RTS                                  ;0091FA|60      |      ;
 
 
          CODE_0091FB: LDA.B wCurrRoomSectionBlock          ;0091FB|A533    |000033;
                       BEQ CODE_0091EE                      ;0091FD|F0EF    |0091EE;
                       BNE CODE_00920F                      ;0091FF|D00E    |00920F;
 
          CODE_009201: LDA.B wCurrRoomSectionBlock          ;009201|A533    |000033;
                       CMP.B #$04                           ;009203|C904    |      ;
                       BEQ CODE_00920F                      ;009205|F008    |00920F;
                       BNE CODE_0091EE                      ;009207|D0E5    |0091EE;
 
          CODE_009209: LDA.B wCurrRoomSectionBlock          ;009209|A533    |000033;
          ...
          CODE_00920F: JSR.W CODE_0090C8                    ;00920F|20C890  |0090C8;
                       ...
                       CMP.B wCurrRoomGroupStage            ;00921E|C532    |000032;
                       BNE DATA8_00923E                     ;009220|D01C    |00923E;
                       LDA.B wCurrRoomSectionBlock          ;009222|A533    |000033;
                       CMP.W DATA8_009245,Y                 ;009224|D94592  |009245;
                       BNE DATA8_00923E                     ;009227|D015    |00923E;
                       LDA.B wCurrRoomIdx                   ;009229|A534    |000034;
          ...
          CODE_009230: LDA.W DATA8_009247,Y                 ;009230|B94792  |009247;
                       STA.B wMapTransitionCheckpoint       ;009233|85A4    |0000A4;
                       LDA.B #$00                           ;009235|A900    |      ;
                       STA.B wMenuOptionIdxSelected         ;009237|856B    |00006B;
                       LDA.B #$17                           ;009239|A917    |      ;
                       STA.B wInGameSubstate                ;00923B|852A    |00002A;
                       RTS                                  ;00923D|60      |      ;
         ...
         DATA8_009247: db $00,$01,$02,$02,$01               ;009247|        |      ;
                       ...
                       LDA.B wMenuOptionIdxSelected         ;009288|A56B    |00006B;
                       db $20                               ;00928A|        |      ;
                       dw jumpFromStackYXpreserved          ;00928B|        |0FE86D;
                       STA.W UNREACH_0FFA92,Y               ;00928D|9992FA  |0FFA92;
                       STA.B (wScrollDirection)             ;009290|9265    |000065;
 
                       STA.B (wDoubleCurrGroup,S),Y         ;009292|930C    |00000C;
                       STY.B wCinematicsControllerBossDefeated,X;009294|942C    |00002C;
                       STY.B wScannlineTarget,X             ;009296|9442    |000042;
                       STY.B wCurrFrameStartingOamOffset,X  ;009298|9420    |000020;
                       LDX.B wWhipSparkTimer                ;00929A|A68C    |00008C;
                       db $20                               ;00929C|        |      ;
          ...
          CODE_0092A6: LDA.W DATA8_0092D5,Y                 ;0092A6|B9D592  |0092D5;
                       ...
                       CMP.B wCurrRoomGroupStage            ;0092AD|C532    |000032;
          ...
          CODE_0092B7: LDA.W DATA8_0092D6,Y                 ;0092B7|B9D692  |0092D6;
                       ...
                       STA.W wEntityFacingLeft              ;0092C0|8DA804  |0004A8;
                       STY.B wAutoWalkPlayer                ;0092C3|84C6    |0000C6;
                       db $20                               ;0092C5|        |      ;
                       dw UNREACH_0FE5CE                    ;0092C6|        |0FE5CE;
                       LDA.B #$00                           ;0092C8|A900    |      ;
                       STA.W wEntityState                   ;0092CA|8D7004  |000470;
                       LDA.B #$00                           ;0092CD|A900    |      ;
                       db $20                               ;0092CF|        |      ;
                       dw CODE_0FEF57                       ;0092D0|        |0FEF57;
                       INC.B wMenuOptionIdxSelected         ;0092D2|E66B    |00006B;
                       RTS                                  ;0092D4|60      |      ;
  ...
  afterBoss_gameState: db $04                               ;0092E3|        |      ;
   ...
   afterBoss_subState: db $1E                               ;0092E4|        |      ;
       ...
       afterBoss_Room: db $00,$00,$08,$00,$00               ;0092E5|        |      ;
                       ...
                       db $01                               ;0092F9|        |      ;
                       LDA.W wEntityXPos                    ;0092FA|AD3804  |000438;
                       LDY.W wEntityFacingLeft              ;0092FD|ACA804  |0004A8;
          ...
          CODE_00930C: LDA.B wCurrRoomGroupStage            ;00930C|A532    |000032;
                       CMP.B #$01                           ;00930E|C901    |      ;
                       BEQ CODE_00931B                      ;009310|F009    |00931B;
                       INC.B wMenuOptionIdxSelected         ;009312|E66B    |00006B;
                       RTS                                  ;009314|60      |      ;
          ...
          CODE_00931B: LDA.B #$11                           ;00931B|A911    |      ;
                       STA.B wInGameSubstate                ;00931D|852A    |00002A;
                       LDA.B #$00                           ;00931F|A900    |      ;
                       STA.W wBoneDragonKingRipsBossGeneral ;009321|8DEC07  |0007EC;
          ...
          CODE_009331: LDA.B wGameStateLoopCounter          ;009331|A51A    |00001A;
          ...
          CODE_00933C: LDA.W wEntityFacingLeft              ;00933C|ADA804  |0004A8;
                       BEQ CODE_009353                      ;00933F|F012    |009353;
                       LDA.W wEntityFractionalX             ;009341|ADC404  |0004C4;
                       SEC                                  ;009344|38      |      ;
                       SBC.B #$C0                           ;009345|E9C0    |      ;
                       STA.W wEntityFractionalX             ;009347|8DC404  |0004C4;
                       LDA.W wEntityXPos                    ;00934A|AD3804  |000438;
                       SBC.B #$00                           ;00934D|E900    |      ;
 
                       STA.W wEntityXPos                    ;00934F|8D3804  |000438;
                       RTS                                  ;009352|60      |      ;
 
 
          CODE_009353: LDA.W wEntityFractionalX             ;009353|ADC404  |0004C4;
                       CLC                                  ;009356|18      |      ;
                       ADC.B #$C0                           ;009357|69C0    |      ;
                       STA.W wEntityFractionalX             ;009359|8DC404  |0004C4;
                       LDA.W wEntityXPos                    ;00935C|AD3804  |000438;
                       ADC.B #$00                           ;00935F|6900    |      ;
                       STA.W wEntityXPos                    ;009361|8D3804  |000438;
                       RTS                                  ;009364|60      |      ;
 
                       INC.B wMenuOptionIdxSelected         ;009365|E66B    |00006B;
                       LDA.B #$0C                           ;009367|A90C    |      ;
                       db $20                               ;009369|        |      ;
 
                       dw CODE_0FE25F                       ;00936A|        |0FE25F;
                       LDA.B #$3C                           ;00936C|A93C    |      ;
                       STA.B wGenericStateTimer             ;00936E|8530    |000030;
                       ...
                       STA.W wOamSpecIdxDoubled,X           ;00937B|9D0004  |000400;
                       STA.W wEntityPaletteOverride,X       ;00937E|9D5404  |000454;
                       LDA.W wEntityYPos                    ;009381|AD1C04  |00041C;
                       ADC.B #$08                           ;009384|6908    |      ;
                       AND.B #$F0                           ;009386|29F0    |      ;
                       STA.W wEntityYPos,X                  ;009388|9D1C04  |00041C;
                       LDA.W wEntityFacingLeft              ;00938B|ADA804  |0004A8;
                       ASL A                                ;00938E|0A      |      ;
                       TAY                                  ;00938F|A8      |      ;
                       LDA.W CODE_009408,Y                  ;009390|B90894  |009408;
                       STA.W wEntityXPos,X                  ;009393|9D3804  |000438;
                       LDA.W LOOSE_OP_009409,Y              ;009396|B90994  |009409;
 
                       STA.W wEntityFacingLeft,X            ;009399|9DA804  |0004A8;
 
                       LDA.B wCurrRoomGroupStage            ;00939C|A532    |000032;
                       CMP.B #$01                           ;00939E|C901    |      ;
                       BEQ CODE_0093F8                      ;0093A0|F056    |0093F8;
                       LDA.B #$00                           ;0093A2|A900    |      ;
                       STA.B $62                            ;0093A4|8562    |000062;
                       LDY.W wEntityObjectIdxes             ;0093A6|AC4E05  |00054E;
                       LDA.W wEntityYPos                    ;0093A9|AD1C04  |00041C;
                       SEC                                  ;0093AC|38      |      ;
                       ...
                       STA.B wVramQueueDest                 ;0093B8|8561    |000061;
                       LDY.W wEntityFacingLeft              ;0093BA|ACA804  |0004A8;
                       LDA.W CODE_009402,Y                  ;0093BD|B90294  |009402;
                       CLC                                  ;0093C0|18      |      ;
                       ADC.B wVramQueueDest                 ;0093C1|6561    |000061;
                       STA.B wVramQueueDest                 ;0093C3|8561    |000061;
                       LDA.B $75                            ;0093C5|A575    |000075;
                       AND.B #$01                           ;0093C7|2901    |      ;
                       STA.B $00                            ;0093C9|8500    |000000;
                       LDA.B wScrollDirection               ;0093CB|A565    |000065;
          ...
          CODE_0093D5: LDA.B wCurrScrollRoomScreen          ;0093D5|A557    |000057;
         ...
         DATA8_0093E7: db $20                               ;0093E7|        |      ;
          ...
          CODE_0093EE: STA.W wVramQueue,X                   ;0093EE|9D0003  |000300;
                       INX                                  ;0093F1|E8      |      ;
                       DEY                                  ;0093F2|88      |      ;
          ...
          CODE_0093F8: LDA.B #$2A                           ;0093F8|A92A    |      ;
                       ...
                       STA.B wVramQueueDest                 ;0093FE|8561    |000061;
          ...
          CODE_009408: PEA.W $0C00                          ;009408|F4000C  |000C00;
                       ORA.B (wAutoWalkPlayer,X)            ;00940B|01C6    |0000C6;
                       BMI LOOSE_OP_0093DF                  ;00940D|30D0    |0093DF;
                       TSB.W wPartnerSwapDrawingLatch       ;00940F|0CA900  |0000A9;
                       db $20                               ;009412|        |      ;
                       dw CODE_0FEF57                       ;009413|        |0FEF57;
 
                       LDA.B #$14                           ;009415|A914    |      ;
                       STA.B wGenericStateTimer             ;009417|8530    |000030;
                       INC.B wMenuOptionIdxSelected         ;009419|E66B    |00006B;
          ...
          CODE_00941B: RTS                                  ;00941B|60      |      ;
                       ...
                       LDA.W wEntityOamSpecIdxBaseOffset,X  ;009421|BD9305  |000593;
 
                       BNE CODE_00941B                      ;009424|D0F5    |00941B;
                       LDA.B #$80                           ;009426|A980    |      ;
                       STA.W wEntityTimeUntilNextAnimation,X;009428|9D7C05  |00057C;
                       RTS                                  ;00942B|60      |      ;
 
                       DEC.B wGenericStateTimer             ;00942C|C630    |000030;
          ...
          CODE_009436: LDA.B #$00                           ;009436|A900    |      ;
                       STA.W wOamSpecIdxDoubled             ;009438|8D0004  |000400;
                       LDA.B #$10                           ;00943B|A910    |      ;
                       STA.B wGenericStateTimer             ;00943D|8530    |000030;
                       INC.B wMenuOptionIdxSelected         ;00943F|E66B    |00006B;
 
          CODE_009441: RTS                                  ;009441|60      |      ;
 
                       DEC.B wGenericStateTimer             ;009442|C630    |000030;
                       BNE CODE_009441                      ;009444|D0FB    |009441;
                       LDA.B #$00                           ;009446|A900    |      ;
                       STA.W wOamSpecIdxDoubled             ;009448|8D0004  |000400;
                       STA.W $0418                          ;00944B|8D1804  |000418;
                       STA.W $0419                          ;00944E|8D1904  |000419;
                       LDY.B wAutoWalkPlayer                ;009451|A4C6    |0000C6;
                       LDA.W afterBoss_gameState,Y          ;009453|B9E392  |0092E3;
                       STA.B wGameState                     ;009456|8518    |000018;
                       LDA.W afterBoss_subState,Y           ;009458|B9E492  |0092E4;
                       STA.B wInGameSubstate                ;00945B|852A    |00002A;
                       LDA.B wCurrRoomSectionBlock          ;00945D|A533    |000033;
                       CLC                                  ;00945F|18      |      ;
                       ADC.W afterBoss_Room,Y               ;009460|79E592  |0092E5;
                       STA.B wCurrRoomSectionBlock          ;009463|8533    |000033;
                       LDA.B #$00                           ;009465|A900    |      ;
                       STA.B wGameSubstate                  ;009467|8519    |000019;
                       RTS                                  ;009469|60      |      ;
 
                       LDA.B wMenuOptionIdxSelected         ;00946A|A56B    |00006B;
                       db $20                               ;00946C|        |      ;
                       dw jumpFromStackYXpreserved          ;00946D|        |0FE86D;
                       LDY.W LOOSE_OP_00BB94                ;00946F|AC94BB  |00BB94;
                       STY.B wPreviousConveyanceBackup88,X  ;009472|94CF    |0000CF;
                       STY.B wUsableChars,X                 ;009474|9439    |000039;
                       STA.B $9B,X                          ;009476|959B    |00009B;
                       STA.B wSoundMetadataAddr,X           ;009478|95E8    |0000E8;
                       STA.B wNametableMapping,X            ;00947A|9525    |000025;
                       STX.B $60,Y                          ;00947C|9660    |000060;
                       STX.B wSizeCurrRoomNumScreens,Y      ;00947E|9671    |000071;
                       STX.B wCurrRoomEntityDataAddrSpawner,Y;009480|9698    |000098;
                       STA.B wSoundBankTempVar2,X           ;009482|95E5    |0000E5;
                       STA.B wPrgBankBkup_8000,X            ;009484|9522    |000022;
                       STX.B $60,Y                          ;009486|9660    |000060;
                       STX.B wSizeCurrRoomNumScreens,Y      ;009488|9671    |000071;
                       STX.B wCollisionValIsForRightHalfOf32x16block,Y;00948A|96A5    |0000A5;
                       RTL                                  ;00948C|6B      |      ;
          ...
          CODE_0094AC: LDA.B #$46                           ;0094AC|A946    |      ;
                       ...
                       STA.B wGenericStateTimer             ;0094B6|8530    |000030;
                       INC.B wMenuOptionIdxSelected         ;0094B8|E66B    |00006B;
                       RTS                                  ;0094BA|60      |      ;
 
 
          CODE_0094BB: DEC.B wGenericStateTimer             ;0094BB|C630    |000030;
                       BEQ CODE_0094C7                      ;0094BD|F008    |0094C7;
                       LDA.B wGameStateLoopCounter          ;0094BF|A51A    |00001A;
                       AND.B #$03                           ;0094C1|2903    |      ;
                       STA.W wEntityPaletteOverride         ;0094C3|8D5404  |000454;
                       RTS                                  ;0094C6|60      |      ;
 
 
          CODE_0094C7: LDA.B #$00                           ;0094C7|A900    |      ;
                       STA.W wEntityPaletteOverride         ;0094C9|8D5404  |000454;
                       INC.B wMenuOptionIdxSelected         ;0094CC|E66B    |00006B;
                       RTS                                  ;0094CE|60      |      ;
 
 
          CODE_0094CF: LDA.B #$4C                           ;0094CF|A94C    |      ;
                       STA.B wGenericStateTimer             ;0094D1|8530    |000030;
                       LDA.W wEntityXPos                    ;0094D3|AD3804  |000438;
                       STA.W $05D4                          ;0094D6|8DD405  |0005D4;
                       LDA.B #$00                           ;0094D9|A900    |      ;
                       STA.W $0505                          ;0094DB|8D0505  |000505;
                       STA.W $051C                          ;0094DE|8D1C05  |00051C;
 
                       STA.W wTimerBatRiverSwap             ;0094E1|8D0206  |000602;
                       LDA.B #$10                           ;0094E4|A910    |      ;
                       STA.W wStairsStuneTimer              ;0094E6|8DEB05  |0005EB;
                       LDA.B #$01                           ;0094E9|A901    |      ;
                       STA.W wWeaponDamage                  ;0094EB|8D3006  |000630;
                       INC.B wMenuOptionIdxSelected         ;0094EE|E66B    |00006B;
                       RTS                                  ;0094F0|60      |      ;
 
 
          CODE_0094F1: LDA.B wPartnerSwapStateBackup        ;0094F1|A5AA    |0000AA;
                       CMP.B #$16                           ;0094F3|C916    |      ;
                       BEQ CODE_009509                      ;0094F5|F012    |009509;
                       LDA.B wBossSecondFace                ;0094F7|A5C2    |0000C2;
                       BNE CODE_009509                      ;0094F9|D00E    |009509;
                       LDA.W wEntityYPos                    ;0094FB|AD1C04  |00041C;
                       SEC                                  ;0094FE|38      |      ;
          ...
          CODE_00950B: LDA.W wEntityYPos                    ;00950B|AD1C04  |00041C;
                       SEC                                  ;00950E|38      |      ;
          ...
          CODE_00951B: JSR.W CODE_0094F1                    ;00951B|20F194  |0094F1;
                       ...
                       LDA.W wEntityYPos                    ;009520|AD1C04  |00041C;
                       SEC                                  ;009523|38      |      ;
                       ...
                       INC.B wMenuOptionIdxSelected         ;009531|E66B    |00006B;
                       RTS                                  ;009533|60      |      ;
 
 
          CODE_009534: LDA.B #$09                           ;009534|A909    |      ;
                       STA.B wMenuOptionIdxSelected         ;009536|856B    |00006B;
                       RTS                                  ;009538|60      |      ;
 
                       JSR.W CODE_00950B                    ;009539|200B95  |00950B;
                       BCS CODE_009550                      ;00953C|B012    |009550;
                       LDA.B #$0B                           ;00953E|A90B    |      ;
                       STA.B wBaseIRQFuncIdx                ;009540|853F    |00003F;
                       LDA.W wEntityYPos                    ;009542|AD1C04  |00041C;
                       SEC                                  ;009545|38      |      ;
                       SBC.B #$0C                           ;009546|E90C    |      ;
                       STA.W $0619                          ;009548|8D1906  |000619;
                       STA.B $7C                            ;00954B|857C    |00007C;
                       INC.B wMenuOptionIdxSelected         ;00954D|E66B    |00006B;
                       RTS                                  ;00954F|60      |      ;
 
 
          CODE_009550: LDA.B #$09                           ;009550|A909    |      ;
                       STA.B wMenuOptionIdxSelected         ;009552|856B    |00006B;
                       RTS                                  ;009554|60      |      ;
 
 
          CODE_009555: LDA.B #$00                           ;009555|A900    |      ;
                       STA.W wEntityState                   ;009557|8D7004  |000470;
                       LDA.W $0505                          ;00955A|AD0505  |000505;
                       BMI CODE_009589                      ;00955D|302A    |009589;
                       LDA.W wWeaponDamage                  ;00955F|AD3006  |000630;
          ...
          CODE_009573: LDA.B #$80                           ;009573|A980    |      ;
                       STA.W wEntityState                   ;009575|8D7004  |000470;
          ...
          CODE_00958C: STA.W wEntityXPos                    ;00958C|8D3804  |000438;
 
          CODE_00958F: LDA.W wWeaponDamage                  ;00958F|AD3006  |000630;
                       EOR.B #$01                           ;009592|4901    |      ;
                       STA.W wWeaponDamage                  ;009594|8D3006  |000630;
                       RTS                                  ;009597|60      |      ;
 
 
          CODE_009598: JSR.W CODE_009555                    ;009598|205595  |009555;
 
          CODE_00959B: DEC.B wGenericStateTimer             ;00959B|C630    |000030;
                       BEQ CODE_0095D8                      ;00959D|F039    |0095D8;
                       LDA.W $051C                          ;00959F|AD1C05  |00051C;
                       CLC                                  ;0095A2|18      |      ;
                       ADC.W wStairsStuneTimer              ;0095A3|6DEB05  |0005EB;
                       STA.W $051C                          ;0095A6|8D1C05  |00051C;
                       LDA.W $0505                          ;0095A9|AD0505  |000505;
 
                       ADC.W wTimerBatRiverSwap             ;0095AC|6D0206  |000602;
          ...
          CODE_0095B7: LDA.W wStairsStuneTimer              ;0095B7|ADEB05  |0005EB;
                       CLC                                  ;0095BA|18      |      ;
                       ADC.B #$10                           ;0095BB|6910    |      ;
                       STA.W wStairsStuneTimer              ;0095BD|8DEB05  |0005EB;
 
                       LDA.W wTimerBatRiverSwap             ;0095C0|AD0206  |000602;
                       ADC.B #$00                           ;0095C3|6900    |      ;
                       STA.W wTimerBatRiverSwap             ;0095C5|8D0206  |000602;
          ...
          CODE_0095CD: LDA.B #$08                           ;0095CD|A908    |      ;
                       STA.W wTimerBatRiverSwap             ;0095CF|8D0206  |000602;
                       LDA.B #$00                           ;0095D2|A900    |      ;
                       STA.W wStairsStuneTimer              ;0095D4|8DEB05  |0005EB;
                       RTS                                  ;0095D7|60      |      ;
 
 
          CODE_0095D8: LDA.B #$80                           ;0095D8|A980    |      ;
                       STA.W wEntityState                   ;0095DA|8D7004  |000470;
                       LDA.B #$00                           ;0095DD|A900    |      ;
                       STA.W $0413                          ;0095DF|8D1304  |000413;
                       INC.B wMenuOptionIdxSelected         ;0095E2|E66B    |00006B;
                       RTS                                  ;0095E4|60      |      ;
         ...
         DATA8_0095E8: db $20                               ;0095E8|        |      ;
                       ...
                       LDA.W wOamSpecIdxDoubled             ;0095EB|AD0004  |000400;
                       CMP.B #$48                           ;0095EE|C948    |      ;
                       BNE CODE_0095F7                      ;0095F0|D005    |0095F7;
                       LDA.B #$04                           ;0095F2|A904    |      ;
                       STA.W wOamSpecIdxDoubled             ;0095F4|8D0004  |000400;
 
          CODE_0095F7: LDA.B wCurrCharacterIdx              ;0095F7|A53B    |00003B;
                       EOR.B #$01                           ;0095F9|4901    |      ;
 
                       STA.B wCurrCharacterIdx              ;0095FB|853B    |00003B;
                       TAY                                  ;0095FD|A8      |      ;
                       LDA.W wUsableChars,Y                 ;0095FE|B93900  |000039;
                       STA.W wEntityObjectIdxes             ;009601|8D4E05  |00054E;
                       ...
                       LDA.W wEntityObjectIdxes             ;009613|AD4E05  |00054E;
                       ASL A                                ;009616|0A      |      ;
                       STA.W wEntityOamSpecGroupDoubled     ;009617|8D8C04  |00048C;
                       LDA.B #$00                           ;00961A|A900    |      ;
                       STA.W wEntityState                   ;00961C|8D7004  |000470;
                       INC.B wMenuOptionIdxSelected         ;00961F|E66B    |00006B;
                       RTS                                  ;009621|60      |      ;
          ...
          CODE_009625: LDA.W $051C                          ;009625|AD1C05  |00051C;
                       SEC                                  ;009628|38      |      ;
                       SBC.W wStairsStuneTimer              ;009629|EDEB05  |0005EB;
                       STA.W $051C                          ;00962C|8D1C05  |00051C;
                       LDA.W $0505                          ;00962F|AD0505  |000505;
                       SBC.W wTimerBatRiverSwap             ;009632|ED0206  |000602;
                       ...
                       STA.W wStairsStuneTimer              ;009642|8DEB05  |0005EB;
                       LDA.B #$00                           ;009645|A900    |      ;
                       STA.W wTimerBatRiverSwap             ;009647|8D0206  |000602;
                       RTS                                  ;00964A|60      |      ;
 
 
          CODE_00964B: LDA.W wStairsStuneTimer              ;00964B|ADEB05  |0005EB;
                       SEC                                  ;00964E|38      |      ;
                       SBC.B #$10                           ;00964F|E910    |      ;
                       STA.W wStairsStuneTimer              ;009651|8DEB05  |0005EB;
                       LDA.W wTimerBatRiverSwap             ;009654|AD0206  |000602;
                       SBC.B #$00                           ;009657|E900    |      ;
                       STA.W wTimerBatRiverSwap             ;009659|8D0206  |000602;
                       RTS                                  ;00965C|60      |      ;
 
 
          CODE_00965D: INC.B wMenuOptionIdxSelected         ;00965D|E66B    |00006B;
                       RTS                                  ;00965F|60      |      ;
 
                       LDA.W $05D4                          ;009660|ADD405  |0005D4;
                       STA.W wEntityXPos                    ;009663|8D3804  |000438;
                       LDA.B #$05                           ;009666|A905    |      ;
                       STA.B wBaseIRQFuncIdx                ;009668|853F    |00003F;
                       LDA.B #$3C                           ;00966A|A93C    |      ;
                       STA.B wGenericStateTimer             ;00966C|8530    |000030;
                       INC.B wMenuOptionIdxSelected         ;00966E|E66B    |00006B;
                       RTS                                  ;009670|60      |      ;
 
                       DEC.B wGenericStateTimer             ;009671|C630    |000030;
 
                       BEQ CODE_00967D                      ;009673|F008    |00967D;
                       LDA.B wGameStateLoopCounter          ;009675|A51A    |00001A;
 
                       AND.B #$03                           ;009677|2903    |      ;
                       STA.W wEntityPaletteOverride         ;009679|8D5404  |000454;
                       RTS                                  ;00967C|60      |      ;
          ...
          CODE_009682: LDA.B wPartnerSwapDrawingBackup      ;009682|A5A6    |0000A6;
                       STA.B wBaseIRQFuncIdx                ;009684|853F    |00003F;
                       LDA.B wPartnerSwapDrawingIRQPointer  ;009686|A5A7    |0000A7;
                       STA.B wBaseIRQCmpVal                 ;009688|8541    |000041;
                       LDA.B $A8                            ;00968A|A5A8    |0000A8;
                       STA.B wScannlineTarget               ;00968C|8542    |000042;
 
                       LDA.B wPartnerSwapDrawingLatch       ;00968E|A5A9    |0000A9;
                       STA.B wBaseIRQStatus                 ;009690|8540    |000040;
 
          CODE_009692: LDA.W $05D4                          ;009692|ADD405  |0005D4;
                       STA.W wEntityXPos                    ;009695|8D3804  |000438;
 
                       LDA.B #$3C                           ;009698|A93C    |      ;
                       STA.B wGenericStateTimer             ;00969A|8530    |000030;
                       INC.B wMenuOptionIdxSelected         ;00969C|E66B    |00006B;
                       RTS                                  ;00969E|60      |      ;
 
 
          CODE_00969F: DEC.B wGenericStateTimer             ;00969F|C630    |000030;
                       BEQ CODE_0096AB                      ;0096A1|F008    |0096AB;
                       LDA.B wGameStateLoopCounter          ;0096A3|A51A    |00001A;
                       AND.B #$03                           ;0096A5|2903    |      ;
                       STA.W wEntityPaletteOverride         ;0096A7|8D5404  |000454;
                       RTS                                  ;0096AA|60      |      ;
 
 
          CODE_0096AB: LDA.B wPartnerSwapStateBackup        ;0096AB|A5AA    |0000AA;
 
          CODE_0096AD: STA.B wInGameSubstate                ;0096AD|852A    |00002A;
                       LDA.B #$00                           ;0096AF|A900    |      ;
                       STA.W wEntityPaletteOverride         ;0096B1|8D5404  |000454;
                       db $20                               ;0096B4|        |      ;
                       ...
                       STA.W wStairsStuneTimer              ;0096C2|8DEB05  |0005EB;
                       STA.W wTimerBatRiverSwap             ;0096C5|8D0206  |000602;
                       STA.W $0619                          ;0096C8|8D1906  |000619;
                       STA.W wWeaponDamage                  ;0096CB|8D3006  |000630;
                       RTS                                  ;0096CE|60      |      ;
 
                       RTS                                  ;0096CF|60      |      ;
 
                       LDA.W wPlayerStateDoubled            ;0096D0|AD6505  |000565;
                       CMP.B #$0E                           ;0096D3|C90E    |      ;
                       BCC CODE_0096F8                      ;0096D5|9021    |0096F8;
                       CMP.B #$16                           ;0096D7|C916    |      ;
                       BCS CODE_0096F8                      ;0096D9|B01D    |0096F8;
                       LDA.W wEntityYPos                    ;0096DB|AD1C04  |00041C;
                       CMP.B #$70                           ;0096DE|C970    |      ;
                       BCS CODE_0096F8                      ;0096E0|B016    |0096F8;
                       LDA.B wCurrentRoomEffect             ;0096E2|A57D    |00007D;
                       AND.B #$0F                           ;0096E4|290F    |      ;
                       ASL A                                ;0096E6|0A      |      ;
                       TAY                                  ;0096E7|A8      |      ;
                       LDA.W DATA8_0096FA,Y                 ;0096E8|B9FA96  |0096FA;
                       CMP.B wCurrScrollRoomScreen          ;0096EB|C557    |000057;
                       BNE CODE_0096F8                      ;0096ED|D009    |0096F8;
                       LDA.W DATA8_0096FB,Y                 ;0096EF|B9FB96  |0096FB;
                       CMP.B wCurrScrollOffsetIntoRoomScreen;0096F2|C556    |000056;
         ...
         DATA8_0096FB: db $00,$02,$C8,$00,$00               ;0096FB|        |      ;
          ...
          CODE_00972A: LDA.B #$00                           ;00972A|A900    |      ;
                       STA.B wCurrentRoomEffect             ;00972C|857D    |00007D;
                       CLC                                  ;00972E|18      |      ;
                       RTS                                  ;00972F|60      |      ;
         ...
         DATA8_009733: db $10,$02,$03,$01,$11               ;009733|        |      ;
                       ...
                       LDA.B wCurrentRoomEffect             ;0097E1|A57D    |00007D;
                       AND.B #$0F                           ;0097E3|290F    |      ;
                       TAX                                  ;0097E5|AA      |      ;
                       LDY.W DATA8_0097FA,X                 ;0097E6|BCFA97  |0097FA;
                       LDX.B #$2E                           ;0097E9|A22E    |      ;
                       LDA.B wCurrentRoomEffect             ;0097EB|A57D    |00007D;
         ...
         DATA8_0097FA: db $7E,$5E,$AE,$AE,$AE               ;0097FA|        |      ;
                       ...
                       LDX.W wPlayerDirectionBackup         ;009801|AEA000  |0000A0;
 
                       TYA                                  ;009804|98      |      ;
 
          CODE_009805: STA.W wFogParallelPos,Y              ;009805|998207  |000782;
                       INY                                  ;009808|C8      |      ;
                       CPY.B #$40                           ;009809|C040    |      ;
                       BNE CODE_009805                      ;00980B|D0F8    |009805;
                       LDA.B wCurrentRoomEffect             ;00980D|A57D    |00007D;
         ...
         DATA8_00981C: db $3F,$7F,$30                       ;00981C|        |      ;
                       ...
                       LDA.B (wChrBankBG_0800),Y            ;009821|B14C    |00004C;
                       PLD                                  ;009823|2B      |      ;
                       TYA                                  ;009824|98      |      ;
 
          CODE_009825: PHA                                  ;009825|48      |      ;
                       LDA.B #$80                           ;009826|A980    |      ;
                       STA.B wStaticLayoutBank              ;009828|85B1    |0000B1;
                       PLA                                  ;00982A|68      |      ;
         ...
         DATA8_009858: db $20                               ;009858|        |      ;
          ...
          CODE_009873: STX.B wStaticLayoutBank              ;009873|86B1    |0000B1;
         ...
         DATA8_009BB7: db $07,$17,$20,$0F,$01               ;009BB7|        |      ;
          ...
          CODE_009E03: STA.W wBoneDragonKingRipsBossGeneral,X;009E03|9DEC07  |0007EC;
                       INX                                  ;009E06|E8      |      ;
                       ...
                       STA.B wCinematicsControllerBossDefeated;009E10|852C    |00002C;
                       db $20                               ;009E12|        |      ;
                       ...
                       LDY.B wMapTransitionCheckpoint       ;009E26|A4A4    |0000A4;
                       ...
                       STA.B wCounterUntilCanShowSprBg      ;009E47|851C    |00001C;
 
          CODE_009E49: INC.B wMenuOptionIdxSelected         ;009E49|E66B    |00006B;
          ...
          CODE_009EBE: LDA.B #$20                           ;009EBE|A920    |      ;
                       STA.B wGenericStateTimer             ;009EC0|8530    |000030;
          ...
          CODE_009EFE: RTS                                  ;009EFE|60      |      ;
                       ...
                       STA.B wScrollY                       ;009F2E|85FC    |0000FC;
 
          CODE_009F30: DEC.B wGenericStateTimer             ;009F30|C630    |000030;
          ...
          CODE_009F38: DEC.B wScrollY                       ;009F38|C6FC    |0000FC;
                       LDA.B wScrollY                       ;009F3A|A5FC    |0000FC;
 
                       CMP.B #$F0                           ;009F3C|C9F0    |      ;
                       BCC CODE_009F44                      ;009F3E|9004    |009F44;
                       SBC.B #$10                           ;009F40|E910    |      ;
                       STA.B wScrollY                       ;009F42|85FC    |0000FC;
 
          CODE_009F44: LDA.W $07EE                          ;009F44|ADEE07  |0007EE;
                       AND.B #$F8                           ;009F47|29F8    |      ;
 
                       CMP.B wScrollY                       ;009F49|C5FC    |0000FC;
          ...
          CODE_009F5B: LDA.B #$00                           ;009F5B|A900    |      ;
                       ...
                       STA.B wGenericStateTimer             ;009F74|8530    |000030;
                       JMP.W CODE_009E49                    ;009F76|4C499E  |009E49;
 
 
          CODE_009F79: JSR.W CODE_009E49                    ;009F79|20499E  |009E49;
                       LDA.B #$08                           ;009F7C|A908    |      ;
                       STA.B wMenuOptionIdxSelected         ;009F7E|856B    |00006B;
                       LDA.B #$40                           ;009F80|A940    |      ;
                       STA.B wGenericStateTimer             ;009F82|8530    |000030;
          ...
          CODE_009F85: JSR.W CODE_009E49                    ;009F85|20499E  |009E49;
                       ...
                       STA.B wMenuOptionIdxSelected         ;009F8A|856B    |00006B;
                       LDA.B #$40                           ;009F8C|A940    |      ;
                       STA.B wGenericStateTimer             ;009F8E|8530    |000030;
 
                       RTS                                  ;009F90|60      |      ;
 
                       JSR.W CODE_00A0A8                    ;009F91|20A8A0  |00A0A8;
                       DEC.B wGenericStateTimer             ;009F94|C630    |000030;
                       ...
                       STA.B wMenuOptionIdxSelected         ;009FA5|856B    |00006B;
                       LDA.B #$40                           ;009FA7|A940    |      ;
 
                       STA.B wGenericStateTimer             ;009FA9|8530    |000030;
 
          CODE_009FAB: RTS                                  ;009FAB|60      |      ;
 
                       LDY.W $07F3                          ;009FAC|ACF307  |0007F3;
                       BNE CODE_009FB9                      ;009FAF|D008    |009FB9;
                       DEC.B wGenericStateTimer             ;009FB1|C630    |000030;
          ...
          CODE_009FB9: LDA.B #$AA                           ;009FB9|A9AA    |      ;
                       ...
                       ADC.W wEntityFractionalX,X           ;009FC3|7DC404  |0004C4;
                       STA.W wEntityFractionalX,X           ;009FC6|9DC404  |0004C4;
                       LDA.B #$00                           ;009FC9|A900    |      ;
                       ADC.W wEntityXPos,X                  ;009FCB|7D3804  |000438;
                       STA.W wEntityXPos,X                  ;009FCE|9D3804  |000438;
                       CLC                                  ;009FD1|18      |      ;
                       LDA.B #$F0                           ;009FD2|A9F0    |      ;
                       ADC.W wEntityFractionalY,X           ;009FD4|7DDB04  |0004DB;
                       STA.W wEntityFractionalY,X           ;009FD7|9DDB04  |0004DB;
                       LDA.B #$FF                           ;009FDA|A9FF    |      ;
                       ADC.W wEntityYPos,X                  ;009FDC|7D1C04  |00041C;
                       STA.W wEntityYPos,X                  ;009FDF|9D1C04  |00041C;
                       LDA.W wEntityXPos,X                  ;009FE2|BD3804  |000438;
                       CMP.B #$9A                           ;009FE5|C99A    |      ;
 
                       BCC CODE_00A04F                      ;009FE7|9066    |00A04F;
                       LDA.B #$4F                           ;009FE9|A94F    |      ;
                       STA.B wGenericStateTimer             ;009FEB|8530    |000030;
                       JMP.W CODE_009E49                    ;009FED|4C499E  |009E49;
 
                       JSR.W CODE_00A0B1                    ;009FF0|20B1A0  |00A0B1;
                       DEC.B wGenericStateTimer             ;009FF3|C630    |000030;
                       ...
                       STA.B wGenericStateTimer             ;00A001|8530    |000030; NES PRG 2000
          ...
          CODE_00A04F: RTS                                  ;00A04F|60      |      ;
                       ...
                       LDA.B wVramQueueNextIdxToFill        ;00A053|A51D    |00001D;
                       STA.B w015                           ;00A055|8515    |000015;
          ...
          CODE_00A06D: LDY.B #$1E                           ;00A06D|A01E    |      ;
                       ...
                       STA.W wFogParallelPos                ;00A080|8D8207  |000782;
                       RTS                                  ;00A083|60      |      ;
          ...
          CODE_00A0B7: AND.B wGenericStateTimer             ;00A0B7|2530    |000030;
                       BEQ CODE_00A0A2                      ;00A0B9|F0E7    |00A0A2;
                       JMP.W CODE_00A084                    ;00A0BB|4C84A0  |00A084;
 
 
          CODE_00A0BE: LDA.B wGenericStateTimer             ;00A0BE|A530    |000030;
                       LSR A                                ;00A0C0|4A      |      ;
                       LSR A                                ;00A0C1|4A      |      ;
                       LSR A                                ;00A0C2|4A      |      ;
                       LSR A                                ;00A0C3|4A      |      ;
         ...
         DATA8_00A0CB: db $01,$02,$04,$08,$10               ;00A0CB|        |      ;
          ...
          CODE_00A0D0: LDX.B #$01                           ;00A0D0|A201    |      ;
                       LDA.W wOamSpecIdxDoubled,X           ;00A0D2|BD0004  |000400;
          ...
          CODE_00A0E0: LDA.B wPartnerIdx                    ;00A0E0|A53A    |00003A;
                       BMI CODE_00A11C                      ;00A0E2|3038    |00A11C;
                       LDX.B #$02                           ;00A0E4|A202    |      ;
                       LDA.W wOamSpecIdxDoubled,X           ;00A0E6|BD0004  |000400;
         ...
         DATA8_00A0F1: db $20                               ;00A0F1|        |      ;
                       ...
                       STA.B wNametableMapping              ;00A0F6|8525    |000025;
                       LDA.B wPPUCtrl                       ;00A0F8|A5FF    |0000FF;
                       AND.B #$FC                           ;00A0FA|29FC    |      ;
                       STA.B wPPUCtrl                       ;00A0FC|85FF    |0000FF;
                       LDA.B #$00                           ;00A0FE|A900    |      ;
                       STA.B wMenuOptionIdxSelected         ;00A100|856B    |00006B;
                       LDA.B #$1F                           ;00A102|A91F    |      ;
 
                       STA.B wInGameSubstate                ;00A104|852A    |00002A;
                       LDA.B wMapTransitionCheckpoint       ;00A106|A5A4    |0000A4;
                       ASL A                                ;00A108|0A      |      ;
                       CLC                                  ;00A109|18      |      ;
                       ADC.B wMapTransitionCheckpoint       ;00A10A|65A4    |0000A4;
                       TAY                                  ;00A10C|A8      |      ;
                       LDA.W DATA8_00A11D,Y                 ;00A10D|B91DA1  |00A11D;
                       STA.B wCurrRoomGroupStage            ;00A110|8532    |000032;
                       LDA.W DATA8_00A11E,Y                 ;00A112|B91EA1  |00A11E;
                       STA.B wCurrRoomSectionBlock          ;00A115|8533    |000033;
                       LDA.W DATA8_00A11F,Y                 ;00A117|B91FA1  |00A11F;
                       STA.B wCurrRoomIdx                   ;00A11A|8534    |000034;
...
loadPointerScreenLoad: dw LOOSE_OP_00BA6A                   ;00A14D|        |00BA6A;
   ...
   RLE_namScreenIndex: dw $FE0C,$1C0C,$1210                 ;00A15D|        |      ;
                       ...
                       STA.B wCurrDrawnEntityCachedAttr     ;00A17B|8510    |000010;
                       LDA.W RLE_namScreenMapping_5105,Y    ;00A17D|B96EA1  |00A16E;
                       STA.B wNametableMapping              ;00A180|8525    |000025;
                       STA.W $5105                          ;00A182|8D0551  |005105;
 
          CODE_00A185: LDY.B wCurrDrawnEntityCachedAttr     ;00A185|A410    |000010;
         ...
         DATA8_00A194: db $20                               ;00A194|        |      ;
                       ...
                       INC.B wCurrDrawnEntityCachedAttr     ;00A197|E610    |000010;
          ...
          CODE_00A19C: CPX.B #$FF                           ;00A19C|E0FF    |      ;
                       ...
                       STA.B wCurrDrawnEntityCachedAttr     ;00A1A2|8510    |000010;
 
          CODE_00A1A4: LDY.B wCurrDrawnEntityCachedAttr     ;00A1A4|A410    |000010;
                       ...
                       INC.B wCurrDrawnEntityCachedAttr     ;00A1BC|E610    |000010;
                       INC.B wCurrDrawnEntityCachedAttr     ;00A1BE|E610    |000010;
                       LDA.B wCurrDrawnEntityCachedAttr     ;00A1C0|A510    |000010;
          ...
          CODE_00A1D2: JSR.W CODE_00A1E0                    ;00A1D2|20E0A1  |00A1E0;
                       ...
                       STA.B wChrBankBG_0000                ;00A1D7|854A    |00004A;
                       STA.B wChrBankBG_0400                ;00A1D9|854B    |00004B;
                       STA.B wChrBankBG_0800                ;00A1DB|854C    |00004C;
                       STA.B wChrBankBG_0c00                ;00A1DD|854D    |00004D;
 
          CODE_00A1DF: RTS                                  ;00A1DF|60      |      ;
 
 
          CODE_00A1E0: LDA.B #$00                           ;00A1E0|A900    |      ;
                       STA.B wChrBankSpr_0000               ;00A1E2|8546    |000046;
                       LDY.B wPartnerIdx                    ;00A1E4|A43A    |00003A;
                       INY                                  ;00A1E6|C8      |      ;
                       LDA.W DATA8_00A1F5,Y                 ;00A1E7|B9F5A1  |00A1F5;
                       STA.B wChrBankSpr_0400               ;00A1EA|8547    |000047;
                       LDA.B #$7E                           ;00A1EC|A97E    |      ;
                       STA.B wChrBankSpr_0800               ;00A1EE|8548    |000048;
                       LDA.B #$7B                           ;00A1F0|A97B    |      ;
                       STA.B wChrBankSpr_0c00               ;00A1F2|8549    |000049;
                       RTS                                  ;00A1F4|60      |      ;
         ...
         DATA8_00A1FA: db $A5,$30,$29,$0F,$D0               ;00A1FA|        |      ;
                       ...
                       LDA.B wGameStateLoopCounter          ;00A217|A51A    |00001A;
          ...
          CODE_00A224: LDA.B $00                            ;00A224|A500    |000000;
                       STA.B wScrollX                       ;00A226|85FD    |0000FD;
                       ASL A                                ;00A228|0A      |      ;
                       LDA.B wPPUCtrl                       ;00A229|A5FF    |0000FF;
                       AND.B #$FE                           ;00A22B|29FE    |      ;
                       STA.B $00                            ;00A22D|8500    |000000;
                       LDA.B #$00                           ;00A22F|A900    |      ;
                       ROL A                                ;00A231|2A      |      ;
                       ORA.B $00                            ;00A232|0500    |000000;
                       STA.B wPPUCtrl                       ;00A234|85FF    |0000FF;
                       RTS                                  ;00A236|60      |      ;
          ...
          CODE_00A257: LDA.B #$00                           ;00A257|A900    |      ;
                       STA.W wOamSpecIdxDoubled,X           ;00A259|9D0004  |000400;
                       STA.W wEntityOamSpecGroupDoubled,X   ;00A25C|9D8C04  |00048C;
                       STA.W wEntityXPos,X                  ;00A25F|9D3804  |000438;
                       STA.W wEntityYPos,X                  ;00A262|9D1C04  |00041C;
                       STA.W wEntityPaletteOverride,X       ;00A265|9D5404  |000454;
                       STA.W wEntityState,X                 ;00A268|9D7004  |000470;
                       STA.W wEntityFacingLeft,X            ;00A26B|9DA804  |0004A8;
                       STA.W wEntityAnimationDefIdxInSpecGroup,X;00A26E|9DAA05  |0005AA;
                       RTS                                  ;00A271|60      |      ;
          ...
          CODE_00A289: LDA.B wPartnerIdx                    ;00A289|A53A    |00003A;
          ...
          CODE_00A2BC: JSR.W CODE_00A2A3                    ;00A2BC|20A3A2  |00A2A3;
                       ...
                       STA.W wSpawnerID                     ;00A2CF|8DC207  |0007C2;
                       RTS                                  ;00A2D2|60      |      ;
         ...
         DATA8_00A2D3: db $0F,$0F,$16,$24,$0F               ;00A2D3|        |      ;
          ...
          CODE_00A310: STY.B wCollisionPointYinScreen       ;00A310|8411    |000011;
                       INC.W wBoneDragonKingRipsBossGeneral ;00A312|EEEC07  |0007EC;
                       LDA.W $07ED                          ;00A315|ADED07  |0007ED;
                       AND.B #$1F                           ;00A318|291F    |      ;
                       CMP.B #$0E                           ;00A31A|C90E    |      ;
                       BCS CODE_00A340                      ;00A31C|B022    |00A340;
                       LDA.W wBoneDragonKingRipsBossGeneral ;00A31E|ADEC07  |0007EC;
          ...
          CODE_00A32C: LDA.B wCollisionPointYinScreen       ;00A32C|A511    |000011;
                       BNE CODE_00A38B                      ;00A32E|D05B    |00A38B;
                       LDX.B #$03                           ;00A330|A203    |      ;
 
          CODE_00A332: LDA.W wEntityState,X                 ;00A332|BD7004  |000470;
                       AND.B #$7F                           ;00A335|297F    |      ;
                       STA.W wEntityState,X                 ;00A337|9D7004  |000470;
                       INX                                  ;00A33A|E8      |      ;
          ...
          CODE_00A340: LDA.W wBoneDragonKingRipsBossGeneral ;00A340|ADEC07  |0007EC;
                       AND.B #$7F                           ;00A343|297F    |      ;
                       STA.B $00                            ;00A345|8500    |000000;
                       LDA.W wBoneDragonKingRipsBossGeneral ;00A347|ADEC07  |0007EC;
          ...
          CODE_00A372: TYA                                  ;00A372|98      |      ;
                       STA.W wEntityAnimationDefIdxInSpecGroup,X;00A373|9DAA05  |0005AA;
 
          CODE_00A376: RTS                                  ;00A376|60      |      ;
 
 
          CODE_00A377: LDA.B wCollisionPointYinScreen       ;00A377|A511    |000011;
                       BNE CODE_00A39C                      ;00A379|D021    |00A39C;
                       LDX.B #$03                           ;00A37B|A203    |      ;
 
          CODE_00A37D: LDA.W wEntityState,X                 ;00A37D|BD7004  |000470;
                       ORA.B #$80                           ;00A380|0980    |      ;
                       STA.W wEntityState,X                 ;00A382|9D7004  |000470;
                       INX                                  ;00A385|E8      |      ;
          ...
          CODE_00A38B: JSR.W CODE_00A084                    ;00A38B|2084A0  |00A084;
                       ...
                       STA.B wCurrDrawnEntityCachedAttr     ;00A397|8510    |000010;
          ...
          CODE_00A39C: JSR.W CODE_00A0A2                    ;00A39C|20A2A0  |00A0A2;
                       ...
                       STA.B wCurrDrawnEntityCachedAttr     ;00A3A8|8510    |000010;
                       JMP.W CODE_00A272                    ;00A3AA|4C72A2  |00A272;
 
 
          CODE_00A3AD: LDY.B wCurrCharacterIdx              ;00A3AD|A43B    |00003B;
                       LDA.W wUsableChars,Y                 ;00A3AF|B93900  |000039;
                       TAY                                  ;00A3B2|A8      |      ;
                       LDX.B #$01                           ;00A3B3|A201    |      ;
 
          CODE_00A3B5: LDA.W DATA8_00A419,Y                 ;00A3B5|B919A4  |00A419;
                       STA.W wEntityPaletteOverride,X       ;00A3B8|9D5404  |000454;
                       LDA.W DATA8_00A415,Y                 ;00A3BB|B915A4  |00A415;
                       STA.W wEntityYPos,X                  ;00A3BE|9D1C04  |00041C;
                       LDA.W DATA8_00A411,Y                 ;00A3C1|B911A4  |00A411;
                       STA.W wEntityAnimationDefIdxInSpecGroup,X;00A3C4|9DAA05  |0005AA;
                       LDA.W DATA8_00A40D,Y                 ;00A3C7|B90DA4  |00A40D;
                       STA.W wEntityOamSpecGroupDoubled,X   ;00A3CA|9D8C04  |00048C;
                       LDA.B #$01                           ;00A3CD|A901    |      ;
                       STA.W wEntityTimeUntilNextAnimation,X;00A3CF|9D7C05  |00057C;
                       LDA.B #$00                           ;00A3D2|A900    |      ;
                       STA.W wEntityOamSpecIdxBaseOffset,X  ;00A3D4|9D9305  |000593;
          ...
          CODE_00A3E2: TYA                                  ;00A3E2|98      |      ;
                       STA.W wEntityXPos,X                  ;00A3E3|9D3804  |000438;
 
                       BPL DATA8_00A3EB                     ;00A3E6|1003    |00A3EB;
                       INC.W wEntityFacingLeft,X            ;00A3E8|FEA804  |0004A8;
         ...
         DATA8_00A3EB: db $4C                               ;00A3EB|        |      ;
          ...
          CODE_00A3F9: LDX.B #$02                           ;00A3F9|A202    |      ;
                       LDA.W wOamSpecIdxDoubled,X           ;00A3FB|BD0004  |000400;
                       BNE DATA8_00A433                     ;00A3FE|D033    |00A433;
                       LDY.B wPartnerIdx                    ;00A400|A43A    |00003A;
                       BMI DATA8_00A433                     ;00A402|302F    |00A433;
                       LDA.B wCurrCharacterIdx              ;00A404|A53B    |00003B;
         ...
         DATA8_00A433: db $60,$DE,$38,$04,$BD               ;00A433|        |      ;
          ...
          CODE_00A45C: LDA.B #$0C                           ;00A45C|A90C    |      ;
                       STA.W wEntityOamSpecGroupDoubled,X   ;00A45E|9D8C04  |00048C;
                       LDA.B #$00                           ;00A461|A900    |      ;
                       STA.W wEntityState,X                 ;00A463|9D7004  |000470;
                       LDA.B #$00                           ;00A466|A900    |      ;
                       STA.W wEntityPaletteOverride,X       ;00A468|9D5404  |000454;
                       LDA.B #$01                           ;00A46B|A901    |      ;
                       STA.W wEntityFacingLeft,X            ;00A46D|9DA804  |0004A8;
                       STA.W wEntityTimeUntilNextAnimation,X;00A470|9D7C05  |00057C;
                       LDA.B ($00),Y                        ;00A473|B100    |000000;
                       STA.W wOamSpecIdxDoubled,X           ;00A475|9D0004  |000400;
                       INY                                  ;00A478|C8      |      ;
                       LDA.B ($00),Y                        ;00A479|B100    |000000;
                       STA.W wEntityXPos,X                  ;00A47B|9D3804  |000438;
                       INY                                  ;00A47E|C8      |      ;
                       LDA.B ($00),Y                        ;00A47F|B100    |000000;
                       STA.W wEntityYPos,X                  ;00A481|9D1C04  |00041C;
                       INY                                  ;00A484|C8      |      ;
                       INX                                  ;00A485|E8      |      ;
    ...
    gameState8_states: LDA.B wGameSubstate                  ;00A5B7|A519    |000019;
                       db $20                               ;00A5B9|        |      ;
 ...
 gameState8_substate0: db $20                               ;00A5D6|        |      ;
                       ...
                       LDA.B wCurrRoomGroupStage            ;00A5E1|A532    |000032;
          ...
          CODE_00A5ED: STY.W wSoundModeSongSelected         ;00A5ED|8C8007  |000780;
                       INC.B wGameSubstate                  ;00A5F0|E619    |000019;
                       RTS                                  ;00A5F2|60      |      ;
 ...
 gameState8_substate1: db $20                               ;00A5F3|        |      ;
          ...
          CODE_00A5F8: LDA.W screensCHR_Data,Y              ;00A5F8|B93FA6  |00A63F;
                       STA.W wChrBankSpr_0800,Y             ;00A5FB|994800  |000048;
                       INY                                  ;00A5FE|C8      |      ;
                       ...
                       LDA.W wSoundModeSongSelected         ;00A614|AD8007  |000780;
                       BEQ CODE_00A61E                      ;00A617|F005    |00A61E;
                       LDA.B #$17                           ;00A619|A917    |      ;
                       db $20                               ;00A61B|        |      ;
                       dw screenLoadRoutine                 ;00A61C|        |0FECE9;
 
          CODE_00A61E: LDA.W wSoundModeSongSelected         ;00A61E|AD8007  |000780;
 
                       ASL A                                ;00A621|0A      |      ;
                       TAY                                  ;00A622|A8      |      ;
                       LDA.W DATA16_00AE1F,Y                ;00A623|B91FAE  |00AE1F;
                       STA.B wCurrNumToVramQueue            ;00A626|8508    |000008;
                       ...
                       INC.B wGameSubstate                  ;00A63C|E619    |000019;
                       RTS                                  ;00A63E|60      |      ;
 ...
 gameState8_substate2: db $20                               ;00A645|        |      ;
          ...
          CODE_00A64B: LDY.B #$00                           ;00A64B|A000    |      ;
                       STY.W wBGanimationTimer              ;00A64D|8C8107  |000781;
                       INY                                  ;00A650|C8      |      ;
                       STY.W wFogParallelPos                ;00A651|8C8207  |000782;
                       INC.B wGameSubstate                  ;00A654|E619    |000019;
                       RTS                                  ;00A656|60      |      ;
 
 
 gameState8_substate3: DEC.W wFogParallelPos                ;00A657|CE8207  |000782;
                       BEQ CODE_00A65D                      ;00A65A|F001    |00A65D;
                       RTS                                  ;00A65C|60      |      ;
 
 
          CODE_00A65D: LDA.W wBGanimationTimer              ;00A65D|AD8107  |000781;
                       ASL A                                ;00A660|0A      |      ;
                       ASL A                                ;00A661|0A      |      ;
                       TAY                                  ;00A662|A8      |      ;
                       ...
                       STA.W wFogParallelPos                ;00A688|8D8207  |000782;
                       LDA.B #$04                           ;00A68B|A904    |      ;
                       db $20                               ;00A68D|        |      ;
                       dw screenLoadRoutine                 ;00A68E|        |0FECE9;
                       INC.W wBGanimationTimer              ;00A690|EE8107  |000781;
                       RTS                                  ;00A693|60      |      ;
 
 
          CODE_00A694: LDA.B #$00                           ;00A694|A900    |      ;
                       STA.W wBGanimationTimer              ;00A696|8D8107  |000781;
                       INC.B wGameSubstate                  ;00A699|E619    |000019;
                       RTS                                  ;00A69B|60      |      ;
 ...
 gameState8_substate4: LDA.W wSoundModeSongSelected         ;00A6B1|AD8007  |000780;
                       ASL A                                ;00A6B4|0A      |      ;
                       TAY                                  ;00A6B5|A8      |      ;
                       LDA.W DATA16_00AE25,Y                ;00A6B6|B925AE  |00AE25;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00A6B9|850A    |00000A;
                       LDA.W DATA16_00AE26,Y                ;00A6BB|B926AE  |00AE26;
                       STA.B $0B                            ;00A6BE|850B    |00000B;
                       LDA.W wBGanimationTimer              ;00A6C0|AD8107  |000781;
                       ASL A                                ;00A6C3|0A      |      ;
                       TAY                                  ;00A6C4|A8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A6C5|B10A    |00000A;
                       STA.B wCurrNumToVramQueue            ;00A6C7|8508    |000008;
                       INY                                  ;00A6C9|C8      |      ;
                       CMP.B #$FF                           ;00A6CA|C9FF    |      ;
                       BEQ CODE_00A6D9                      ;00A6CC|F00B    |00A6D9;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A6CE|B10A    |00000A;
          ...
          CODE_00A6D9: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A6D9|B10A    |00000A;
                       CMP.B #$FF                           ;00A6DB|C9FF    |      ;
                       BNE CODE_00A6D0                      ;00A6DD|D0F1    |00A6D0;
 
                       LDA.W wSoundModeSongSelected         ;00A6DF|AD8007  |000780;
                       ASL A                                ;00A6E2|0A      |      ;
                       ASL A                                ;00A6E3|0A      |      ;
                       CLC                                  ;00A6E4|18      |      ;
                       ADC.W wSoundModeSongSelected         ;00A6E5|6D8007  |000780;
                       TAY                                  ;00A6E8|A8      |      ;
 ...
 gameState8_substate5: LDA.B #$00                           ;00A724|A900    |      ;
                       LDY.W wEffectSpeedGeneral            ;00A726|AC8407  |000784;
                       BPL CODE_00A72D                      ;00A729|1002    |00A72D;
                       LDA.B #$FF                           ;00A72B|A9FF    |      ;
 
          CODE_00A72D: STA.B $01                            ;00A72D|8501    |000001;
                       LDA.W wPWdumpGeneral                 ;00A72F|AD8807  |000788;
                       SEC                                  ;00A732|38      |      ;
                       SBC.W $0783                          ;00A733|ED8307  |000783;
                       STA.W wPWdumpGeneral                 ;00A736|8D8807  |000788;
                       LDA.B wScrollX                       ;00A739|A5FD    |0000FD;
                       SBC.W wEffectSpeedGeneral            ;00A73B|ED8407  |000784;
                       STA.B wScrollX                       ;00A73E|85FD    |0000FD;
                       ...
                       LDA.B wPPUCtrl                       ;00A74C|A5FF    |0000FF;
                       AND.B #$FE                           ;00A74E|29FE    |      ;
                       ORA.B $00                            ;00A750|0500    |000000;
                       STA.B wPPUCtrl                       ;00A752|85FF    |0000FF;
                       LDA.W $0789                          ;00A754|AD8907  |000789;
                       CLC                                  ;00A757|18      |      ;
                       ADC.W wEffectSpeedSupGeneral         ;00A758|6D8507  |000785;
                       STA.W $0789                          ;00A75B|8D8907  |000789;
                       LDA.B wScrollY                       ;00A75E|A5FC    |0000FC;
                       ADC.W wPWiconGeneral                 ;00A760|6D8607  |000786;
                       STA.B wScrollY                       ;00A763|85FC    |0000FC;
                       ...
                       LDY.W wSoundModeSongSelected         ;00A770|AC8007  |000780;
                       ...
                       LDA.W wSoundModeSongSelected         ;00A785|AD8007  |000780;
                       ASL A                                ;00A788|0A      |      ;
                       TAY                                  ;00A789|A8      |      ;
                       ...
                       STA.W wEpilogTimer                   ;00A798|8D8A07  |00078A;
                       LDA.B wPPUCtrl                       ;00A79B|A5FF    |0000FF;
                       ORA.B #$01                           ;00A79D|0901    |      ;
                       STA.W $078B                          ;00A79F|8D8B07  |00078B;
 
                       LDA.B #$00                           ;00A7A2|A900    |      ;
                       STA.W wBGanimationTimer              ;00A7A4|8D8107  |000781;
                       INC.B wGameSubstate                  ;00A7A7|E619    |000019;
  ...
  AndMoreProgData_78c: db $20,$22,$E0,$22,$A0               ;00A7AE|        |      ;
         ...
         DATA8_00A7B3: db $A5,$1A,$29,$10,$F0               ;00A7B3|        |      ;
          ...
          CODE_00A7BF: LDA.W $0791,Y                        ;00A7BF|B99107  |000791;
                       ...
                       STA.W wEntityState,X                 ;00A7C8|9D7004  |000470;
                       INY                                  ;00A7CB|C8      |      ;
          ...
          CODE_00A7F8: LDY.B $07                            ;00A7F8|A407    |000007;
                       ...
                       STA.B wCurrNumToVramQueue            ;00A7FD|8508    |000008;
                       LDA.W DATA8_00A829,Y                 ;00A7FF|B929A8  |00A829;
                       STA.B $09                            ;00A802|8509    |000009;
                       LDY.B #$00                           ;00A804|A000    |      ;
                       LDA.W wEntityYPos                    ;00A806|AD1C04  |00041C;
                       CMP.B (wCurrNumToVramQueue),Y        ;00A809|D108    |000008;
                       BCC CODE_00A80F                      ;00A80B|9002    |00A80F;
                       INY                                  ;00A80D|C8      |      ;
                       INY                                  ;00A80E|C8      |      ;
 
          CODE_00A80F: INY                                  ;00A80F|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00A810|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00A812|850A    |00000A;
                       INY                                  ;00A814|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00A815|B108    |000008;
                       STA.B $0B                            ;00A817|850B    |00000B;
                       LDY.B #$00                           ;00A819|A000    |      ;
 
          CODE_00A81B: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A81B|B10A    |00000A;
...
progre_pathSpriteMap_01: db $A0,$61,$A8,$65,$A8               ;00A84A|        |      ;
         ...
         DATA8_00A871: db $AD,$80,$07,$0A,$A8               ;00A871|        |      ;
                       ...
                       STA.B wCurrNumToVramQueue            ;00A879|8508    |000008;
                       LDA.W DATA8_00ADD8,Y                 ;00A87B|B9D8AD  |00ADD8;
                       STA.B $09                            ;00A87E|8509    |000009;
                       LDX.B #$01                           ;00A880|A201    |      ;
                       LDY.B #$00                           ;00A882|A000    |      ;
 
          CODE_00A884: LDA.B (wCurrNumToVramQueue),Y        ;00A884|B108    |000008;
                       CMP.B #$FF                           ;00A886|C9FF    |      ;
                       BEQ CODE_00A8AC                      ;00A888|F022    |00A8AC;
                       STA.W wOamSpecIdxDoubled,X           ;00A88A|9D0004  |000400;
                       LDA.B #$0C                           ;00A88D|A90C    |      ;
                       STA.W wEntityOamSpecGroupDoubled,X   ;00A88F|9D8C04  |00048C;
                       LDA.B #$01                           ;00A892|A901    |      ;
                       STA.W wEntityFacingLeft,X            ;00A894|9DA804  |0004A8;
                       LDA.B #$80                           ;00A897|A980    |      ;
                       STA.W wEntityState,X                 ;00A899|9D7004  |000470;
                       INY                                  ;00A89C|C8      |      ;
 
                       LDA.B (wCurrNumToVramQueue),Y        ;00A89D|B108    |000008;
                       STA.W wEntityXPos,X                  ;00A89F|9D3804  |000438;
                       INY                                  ;00A8A2|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00A8A3|B108    |000008;
                       STA.W wEntityYPos,X                  ;00A8A5|9D1C04  |00041C;
                       INY                                  ;00A8A8|C8      |      ;
                       INX                                  ;00A8A9|E8      |      ;
 ...
 gameState8_substate6: JSR.W DATA8_00A7B3                   ;00A8CB|20B3A7  |00A7B3;
                       LDA.W wSoundModeSongSelected         ;00A8CE|AD8007  |000780;
                       ASL A                                ;00A8D1|0A      |      ;
                       TAY                                  ;00A8D2|A8      |      ;
                       LDA.W DATA16_00AE2B,Y                ;00A8D3|B92BAE  |00AE2B;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00A8D6|850A    |00000A;
                       LDA.W DATA16_00AE2C,Y                ;00A8D8|B92CAE  |00AE2C;
                       STA.B $0B                            ;00A8DB|850B    |00000B;
                       LDA.W wBGanimationTimer              ;00A8DD|AD8107  |000781;
                       ASL A                                ;00A8E0|0A      |      ;
                       TAY                                  ;00A8E1|A8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A8E2|B10A    |00000A;
                       STA.B wCurrNumToVramQueue            ;00A8E4|8508    |000008;
                       INY                                  ;00A8E6|C8      |      ;
                       CMP.B #$FF                           ;00A8E7|C9FF    |      ;
                       BEQ CODE_00A8F6                      ;00A8E9|F00B    |00A8F6;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A8EB|B10A    |00000A;
 
          CODE_00A8ED: STA.B $09                            ;00A8ED|8509    |000009;
                       JSR.W CODE_00AD48                    ;00A8EF|2048AD  |00AD48;
                       INC.W wBGanimationTimer              ;00A8F2|EE8107  |000781;
                       RTS                                  ;00A8F5|60      |      ;
 
 
          CODE_00A8F6: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00A8F6|B10A    |00000A;
                       CMP.B #$FF                           ;00A8F8|C9FF    |      ;
                       BNE CODE_00A8ED                      ;00A8FA|D0F1    |00A8ED;
                       LDY.W wSoundModeSongSelected         ;00A8FC|AC8007  |000780;
                       LDA.W DATA8_00A90D,Y                 ;00A8FF|B90DA9  |00A90D;
                       STA.W wEffectSpeedGeneral            ;00A902|8D8407  |000784;
 
                       LDA.B #$01                           ;00A905|A901    |      ;
 
                       STA.W wFogParallelPos                ;00A907|8D8207  |000782;
                       INC.B wGameSubstate                  ;00A90A|E619    |000019;
                       RTS                                  ;00A90C|60      |      ;
 ...
 gameState8_substate7: JSR.W CODE_00A7D5                    ;00A910|20D5A7  |00A7D5;
                       ...
                       LDY.W wEffectSpeedGeneral            ;00A915|AC8407  |000784;
                       BPL CODE_00A91C                      ;00A918|1002    |00A91C;
                       LDA.B #$FF                           ;00A91A|A9FF    |      ;
 
          CODE_00A91C: STA.B $01                            ;00A91C|8501    |000001;
                       SEC                                  ;00A91E|38      |      ;
                       LDA.W wEpilogTimer                   ;00A91F|AD8A07  |00078A;
                       SBC.W wEffectSpeedGeneral            ;00A922|ED8407  |000784;
                       STA.W wEpilogTimer                   ;00A925|8D8A07  |00078A;
                       LDA.W wFogParallelPos                ;00A928|AD8207  |000782;
                       SBC.B $01                            ;00A92B|E501    |000001;
                       STA.W wFogParallelPos                ;00A92D|8D8207  |000782;
                       ...
                       LDA.W wEpilogTimer                   ;00A93E|AD8A07  |00078A;
                       BNE CODE_00A94A                      ;00A941|D007    |00A94A;
                       LDA.B #$00                           ;00A943|A900    |      ;
                       STA.W wPlayerStateDoubled            ;00A945|8D6505  |000565;
 
                       INC.B wGameSubstate                  ;00A948|E619    |000019;
 
          CODE_00A94A: RTS                                  ;00A94A|60      |      ;
 
 
 gameState8_substate8: JSR.W CODE_00A7D5                    ;00A94B|20D5A7  |00A7D5;
                       LDA.W wPlayerStateDoubled            ;00A94E|AD6505  |000565;
          ...
          CODE_00A962: JSR.W CODE_00AA05                    ;00A962|2005AA  |00AA05;
                       LDA.W wPlayerStateDoubled            ;00A965|AD6505  |000565;
                       CMP.B #$12                           ;00A968|C912    |      ;
                       BNE CODE_00A9A4                      ;00A96A|D038    |00A9A4;
                       LDA.W wSoundModeSongSelected         ;00A96C|AD8007  |000780;
                       ASL A                                ;00A96F|0A      |      ;
                       TAY                                  ;00A970|A8      |      ;
                       LDA.W progressionPointerTable,Y      ;00A971|B9A5A9  |00A9A5;
                       STA.B wCurrNumToVramQueue            ;00A974|8508    |000008;
                       ...
                       TAY                                  ;00A983|A8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00A984|B108    |000008;
                       STA.B wCurrRoomGroupStage            ;00A986|8532    |000032;
 
                       INY                                  ;00A988|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00A989|B108    |000008;
                       STA.B wCurrRoomSectionBlock          ;00A98B|8533    |000033;
                       INY                                  ;00A98D|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00A98E|B108    |000008;
                       STA.B wCurrRoomIdx                   ;00A990|8534    |000034;
                       LDA.B #$07                           ;00A992|A907    |      ;
                       STA.W $0160                          ;00A994|8D6001  |000160;
                       LDA.B #$B4                           ;00A997|A9B4    |      ;
                       STA.B wGenericStateTimer             ;00A999|8530    |000030;
                       LDY.B #$00                           ;00A99B|A000    |      ;
                       STY.B $B4                            ;00A99D|84B4    |0000B4;
                       INY                                  ;00A99F|C8      |      ;
                       STY.B $B5                            ;00A9A0|84B5    |0000B5;
                       INC.B wGameSubstate                  ;00A9A2|E619    |000019;
...
progressionPointerTable: dw goClockTower                      ;00A9A5|        |00A9AB;
 ...
 gameState8_substate9: DEC.B wGenericStateTimer             ;00A9C0|C630    |000030;
                       BEQ CODE_00A9CC                      ;00A9C2|F008    |00A9CC;
                       LDA.B wGenericStateTimer             ;00A9C4|A530    |000030;
                       CMP.B #$30                           ;00A9C6|C930    |      ;
                       BCS CODE_00A9CE                      ;00A9C8|B004    |00A9CE;
                       BCC CODE_00A9CF                      ;00A9CA|9003    |00A9CF;
 
          CODE_00A9CC: INC.B wGameSubstate                  ;00A9CC|E619    |000019;
          ...
          CODE_00A9CF: LDA.B $B4                            ;00A9CF|A5B4    |0000B4;
                       ...
                       LDA.B wVramQueueNextIdxToFill        ;00A9D5|A51D    |00001D;
                       PHA                                  ;00A9D7|48      |      ;
 
                       LDY.W wSoundModeSongSelected         ;00A9D8|AC8007  |000780;
                       LDA.W AndMoreProgData_00,Y           ;00A9DB|B9AAA7  |00A7AA;
                       db $20                               ;00A9DE|        |      ;
                       dw screenLoadRoutine                 ;00A9DF|        |0FECE9;
                       JSR.W DATA8_00A8AD                   ;00A9E1|20ADA8  |00A8AD;
                       PLA                                  ;00A9E4|68      |      ;
                       STA.B w015                           ;00A9E5|8515    |000015;
                       db $4C                               ;00A9E7|        |      ;
...
gameState8_substate10: db $20                               ;00A9EA|        |      ;
                       ...
                       LDA.W wSoundModeSongSelected         ;00A9ED|AD8007  |000780;
         ...
         DATA8_00A9F5: db $20                               ;00A9F5|        |      ;
                       ...
                       STA.B wGameState                     ;00A9FD|8518    |000018;
 
                       LDA.B #$00                           ;00A9FF|A900    |      ;
 
                       STA.B wInGameSubstate                ;00AA01|852A    |00002A;
...
gameState8_substateEmpty: RTS                                  ;00AA04|60      |      ;
          ...
          CODE_00AA05: LDA.W wPlayerStateDoubled            ;00AA05|AD6505  |000565;
          ...
          CODE_00AA08: CMP.B #$00                           ;00AA08|C900    |      ;
                       ...
                       LDA.W wSoundModeSongSelected         ;00AA14|AD8007  |000780;
                       ASL A                                ;00AA17|0A      |      ;
                       TAY                                  ;00AA18|A8      |      ;
                       LDA.W wEntityXPos                    ;00AA19|AD3804  |000438;
          ...
          CODE_00AA26: LDA.W wEntityFacingLeft              ;00AA26|ADA804  |0004A8;
                       ASL A                                ;00AA29|0A      |      ;
                       TAY                                  ;00AA2A|A8      |      ;
                       LDA.W DATA16_00AA67,Y                ;00AA2B|B967AA  |00AA67;
                       STA.W wEntityXposSpeed               ;00AA2E|8DF204  |0004F2;
                       LDA.W DATA16_00AA68,Y                ;00AA31|B968AA  |00AA68;
                       STA.W wEntityXposSubSpeed            ;00AA34|8D0905  |000509;
                       LDA.B #$10                           ;00AA37|A910    |      ;
                       STA.W wPlayerStateDoubled            ;00AA39|8D6505  |000565;
          ...
          CODE_00AA46: LDY.W wPlayerStateDoubled            ;00AA46|AC6505  |000565;
                       db $20                               ;00AA49|        |      ;
        ...
        DATA16_00AA67: dw $C000,$40FF                       ;00AA67|        |      ;
                       LDY.W wEntityObjectIdxes             ;00AA6B|AC4E05  |00054E;
                       LDA.W playPosSpdScreen,Y             ;00AA6E|B9DAAA  |00AADA;
                       STA.W wEntityOamSpecGroupDoubled     ;00AA71|8D8C04  |00048C;
                       LDA.B #$02                           ;00AA74|A902    |      ;
                       STA.W wOamSpecIdxDoubled             ;00AA76|8D0004  |000400;
                       LDA.W wSoundModeSongSelected         ;00AA79|AD8007  |000780;
                       ASL A                                ;00AA7C|0A      |      ;
                       ...
                       STA.W wEntityXPos                    ;00AA87|8D3804  |000438;
                       LDA.W DATA8_00AADF,Y                 ;00AA8A|B9DFAA  |00AADF;
                       LDX.W wEntityObjectIdxes             ;00AA8D|AE4E05  |00054E;
                       CPX.B #$02                           ;00AA90|E002    |      ;
                       BNE CODE_00AA97                      ;00AA92|D003    |00AA97;
                       CLC                                  ;00AA94|18      |      ;
                       ADC.B #$04                           ;00AA95|6904    |      ;
 
          CODE_00AA97: STA.W wEntityYPos                    ;00AA97|8D1C04  |00041C;
                       LDA.W progressionPathSelecter,Y      ;00AA9A|B9E0AA  |00AAE0;
                       STA.W wEntityFacingLeft              ;00AA9D|8DA804  |0004A8;
                       LDA.W DATA8_00AAE1,Y                 ;00AAA0|B9E1AA  |00AAE1;
                       STA.W wEntityXposSpeed               ;00AAA3|8DF204  |0004F2;
                       LDA.W DATA8_00AAE2,Y                 ;00AAA6|B9E2AA  |00AAE2;
                       STA.W wEntityXposSubSpeed            ;00AAA9|8D0905  |000509;
                       ...
                       STA.B wRoomOrientation               ;00AAB9|8568    |000068;
                       STA.B wCurrScrollOffsetIntoRoomScreen;00AABB|8556    |000056;
                       STA.B wCurrScrollRoomScreen          ;00AABD|8557    |000057;
                       LDA.W wSoundModeSongSelected         ;00AABF|AD8007  |000780;
                       ASL A                                ;00AAC2|0A      |      ;
                       TAY                                  ;00AAC3|A8      |      ;
                       LDA.W PTR16_00AD96,Y                 ;00AAC4|B996AD  |00AD96;
                       STA.B wCurrRoomStairsDataAddr        ;00AAC7|8569    |000069;
                       LDA.W PTR16_00AD97,Y                 ;00AAC9|B997AD  |00AD97;
                       STA.B $6A                            ;00AACC|856A    |00006A;
                       LDA.B #$00                           ;00AACE|A900    |      ;
                       db $20                               ;00AAD0|        |      ;
                       dw CODE_0FEF57                       ;00AAD1|        |0FEF57;
                       INC.W wPlayerStateDoubled            ;00AAD3|EE6505  |000565;
                       INC.W wPlayerStateDoubled            ;00AAD6|EE6505  |000565;
                       RTS                                  ;00AAD9|60      |      ;
...
progressionPathSelecter: db $00                               ;00AAE0|        |      ;
         ...
         DATA8_00AAE3: db $01,$08,$80,$00,$00               ;00AAE3|        |      ;
                       ...
                       db $FF,$40,$00                       ;00AAED|        |      ;
                       LDA.B wGameStateLoopCounter          ;00AAF0|A51A    |00001A;
         ...
         DATA8_00AAFB: db $20                               ;00AAFB|        |      ;
                       ...
                       LDA.W wEntityFractionalX             ;00AAFE|ADC404  |0004C4;
                       CLC                                  ;00AB01|18      |      ;
                       ADC.W wEntityXposSubSpeed            ;00AB02|6D0905  |000509;
                       STA.W wEntityFractionalX             ;00AB05|8DC404  |0004C4;
                       LDA.W wEntityXPos                    ;00AB08|AD3804  |000438;
                       ADC.W wEntityXposSpeed               ;00AB0B|6DF204  |0004F2;
                       STA.W wEntityXPos                    ;00AB0E|8D3804  |000438;
          ...
          CODE_00AB1E: LDA.B #$00                           ;00AB1E|A900    |      ;
                       STA.W wOamSpecIdxDoubled             ;00AB20|8D0004  |000400;
                       INC.W wPlayerStateDoubled            ;00AB23|EE6505  |000565;
                       INC.W wPlayerStateDoubled            ;00AB26|EE6505  |000565;
 
          CODE_00AB29: RTS                                  ;00AB29|60      |      ;
 
                       LDA.B wJoy1ButtonsPressed            ;00AB2A|A528    |000028;
                       LSR A                                ;00AB2C|4A      |      ;
          ...
          CODE_00AB38: LDA.B #$02                           ;00AB38|A902    |      ;
                       STA.W wOamSpecIdxDoubled             ;00AB3A|8D0004  |000400;
                       RTS                                  ;00AB3D|60      |      ;
         ...
         DATA8_00AB3E: db $20                               ;00AB3E|        |      ;
                       ...
                       STA.W wEntityPhase                   ;00AB45|8DC105  |0005C1;
         ...
         DATA8_00AB4C: db $20                               ;00AB4C|        |      ;
                       ...
                       STA.W wEntityPhase                   ;00AB53|8DC105  |0005C1;
                       LDX.B #$00                           ;00AB56|A200    |      ;
 
          CODE_00AB58: LDY.B #$00                           ;00AB58|A000    |      ;
                       LDA.B wCurrRoomSectionPlayerPosAndScreenAddr;00AB5A|A50A    |00000A;
                       ASL A                                ;00AB5C|0A      |      ;
          ...
          CODE_00AB64: STY.W wEntityAI_idx                  ;00AB64|8CEF05  |0005EF;
                       STX.W wEntityFacingLeft              ;00AB67|8EA804  |0004A8;
                       LDA.B $0B                            ;00AB6A|A50B    |00000B;
                       STA.W wPixelsToWalkToStairs          ;00AB6C|8D1D06  |00061D;
                       LDY.B #$00                           ;00AB6F|A000    |      ;
                       ASL A                                ;00AB71|0A      |      ;
                       BCC CODE_00AB75                      ;00AB72|9001    |00AB75;
                       INY                                  ;00AB74|C8      |      ;
 
          CODE_00AB75: STY.W wEntityAlarmOrStartYforSinusoidalMovement;00AB75|8C0606  |000606;
                       LDA.B wDoubleCurrSection             ;00AB78|A50D    |00000D;
          ...
          CODE_00AB86: STY.W wEntityXposSubSpeed            ;00AB86|8C0905  |000509;
                       STA.W wEntityXposSpeed               ;00AB89|8DF204  |0004F2;
                       LDA.B #$08                           ;00AB8C|A908    |      ;
                       STA.W wPlayerStateDoubled            ;00AB8E|8D6505  |000565;
                       LDA.B #$00                           ;00AB91|A900    |      ;
 
          CODE_00AB93: STA.W wEntityAnimationDefIdxInSpecGroup;00AB93|8DAA05  |0005AA;
                       LDY.B #$02                           ;00AB96|A002    |      ;
                       STY.W wEntityOamSpecIdxBaseOffset    ;00AB98|8C9305  |000593;
                       DEY                                  ;00AB9B|88      |      ;
                       STY.W wEntityTimeUntilNextAnimation  ;00AB9C|8C7C05  |00057C;
                       RTS                                  ;00AB9F|60      |      ;
          ...
          CODE_00ABA6: STA.W wEntityFacingLeft              ;00ABA6|8DA804  |0004A8;
                       LDA.B #$00                           ;00ABA9|A900    |      ;
 
                       STA.W wEntityXposSpeed               ;00ABAB|8DF204  |0004F2;
                       STA.W wEntityXposSubSpeed            ;00ABAE|8D0905  |000509;
                       LDA.B #$06                           ;00ABB1|A906    |      ;
                       STA.W wPlayerStateDoubled            ;00ABB3|8D6505  |000565;
                       LDA.B #$00                           ;00ABB6|A900    |      ;
                       JMP.W CODE_00AB93                    ;00ABB8|4C93AB  |00AB93;
 
                       LDA.B wJoy1ButtonsPressed            ;00ABBB|A528    |000028;
                       LSR A                                ;00ABBD|4A      |      ;
                       BCS CODE_00ABDF                      ;00ABBE|B01F    |00ABDF;
                       LSR A                                ;00ABC0|4A      |      ;
                       BCS CODE_00ABFC                      ;00ABC1|B039    |00ABFC;
                       LDA.B #$04                           ;00ABC3|A904    |      ;
                       STA.W wPlayerStateDoubled            ;00ABC5|8D6505  |000565;
 
         DATA8_00ABC8: db $20                               ;00ABC8|        |      ;
                       dw CODE_0FEF73                       ;00ABC9|        |0FEF73;
 
          CODE_00ABCB: LDA.W wEntityFractionalX             ;00ABCB|ADC404  |0004C4;
 
                       CLC                                  ;00ABCE|18      |      ;
                       ADC.W wEntityXposSubSpeed            ;00ABCF|6D0905  |000509;
                       STA.W wEntityFractionalX             ;00ABD2|8DC404  |0004C4;
                       LDA.W wEntityXPos                    ;00ABD5|AD3804  |000438;
                       ADC.W wEntityXposSpeed               ;00ABD8|6DF204  |0004F2;
                       STA.W wEntityXPos                    ;00ABDB|8D3804  |000438;
 
                       RTS                                  ;00ABDE|60      |      ;
 
 
          CODE_00ABDF: LDA.B #$00                           ;00ABDF|A900    |      ;
                       STA.W wEntityFacingLeft              ;00ABE1|8DA804  |0004A8;
                       JSR.W CODE_00AC28                    ;00ABE4|2028AC  |00AC28;
                       LDY.B #$02                           ;00ABE7|A002    |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00ABE9|B10A    |00000A;
                       CMP.W wEntityXPos                    ;00ABEB|CD3804  |000438;
          ...
          CODE_00ABFC: LDA.B #$01                           ;00ABFC|A901    |      ;
                       STA.W wEntityFacingLeft              ;00ABFE|8DA804  |0004A8;
                       JSR.W CODE_00AC28                    ;00AC01|2028AC  |00AC28;
 
                       LDY.B #$01                           ;00AC04|A001    |      ;
 
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00AC06|B10A    |00000A;
                       CMP.W wEntityXPos                    ;00AC08|CD3804  |000438;
                       BCS CODE_00ABF7                      ;00AC0B|B0EA    |00ABF7;
 
                       LDA.B #$FF                           ;00AC0D|A9FF    |      ;
                       LDY.B #$00                           ;00AC0F|A000    |      ;
 
          CODE_00AC11: STY.W wEntityXposSubSpeed            ;00AC11|8C0905  |000509;
                       STA.W wEntityXposSpeed               ;00AC14|8DF204  |0004F2;
                       LDA.B #$00                           ;00AC17|A900    |      ;
                       STA.W wEntityYposSpeed               ;00AC19|8D2005  |000520;
 
                       STA.W wEntityYposSubSpeed            ;00AC1C|8D3705  |000537;
          ...
          CODE_00AC28: LDA.W wSoundModeSongSelected         ;00AC28|AD8007  |000780;
                       ASL A                                ;00AC2B|0A      |      ;
                       TAY                                  ;00AC2C|A8      |      ;
                       LDA.W PTR16_00ADAE,Y                 ;00AC2D|B9AEAD  |00ADAE;
                       STA.B wCurrNumToVramQueue            ;00AC30|8508    |000008;
                       LDA.W PTR16_00ADAF,Y                 ;00AC32|B9AFAD  |00ADAF;
                       STA.B $09                            ;00AC35|8509    |000009;
                       LDA.W $0790                          ;00AC37|AD9007  |000790;
                       ASL A                                ;00AC3A|0A      |      ;
                       TAY                                  ;00AC3B|A8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AC3C|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00AC3E|850A    |00000A;
                       INY                                  ;00AC40|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AC41|B108    |000008;
                       STA.B $0B                            ;00AC43|850B    |00000B;
                       RTS                                  ;00AC45|60      |      ;
 
 
          CODE_00AC46: LDA.W wSoundModeSongSelected         ;00AC46|AD8007  |000780;
                       ASL A                                ;00AC49|0A      |      ;
                       TAY                                  ;00AC4A|A8      |      ;
                       LDA.W PTR16_00AD9C,Y                 ;00AC4B|B99CAD  |00AD9C;
                       STA.B wCurrNumToVramQueue            ;00AC4E|8508    |000008;
                       LDA.W PTR16_00AD9D,Y                 ;00AC50|B99DAD  |00AD9D;
                       STA.B $09                            ;00AC53|8509    |000009;
                       LDY.B #$00                           ;00AC55|A000    |      ;
 
          CODE_00AC57: LDA.B (wCurrNumToVramQueue),Y        ;00AC57|B108    |000008;
                       CMP.B #$FF                           ;00AC59|C9FF    |      ;
                       BEQ CODE_00AC7F                      ;00AC5B|F022    |00AC7F;
                       STA.B $00                            ;00AC5D|8500    |000000;
                       LDX.W wEntityObjectIdxes             ;00AC5F|AE4E05  |00054E;
          ...
          CODE_00AC6B: LDA.B $00                            ;00AC6B|A500    |000000;
                       SEC                                  ;00AC6D|38      |      ;
                       SBC.W wEntityYPos                    ;00AC6E|ED1C04  |00041C;
          ...
          CODE_00AC81: LDA.B $00                            ;00AC81|A500    |000000;
                       TAX                                  ;00AC83|AA      |      ;
                       INY                                  ;00AC84|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AC85|B108    |000008;
                       SEC                                  ;00AC87|38      |      ;
                       RTS                                  ;00AC88|60      |      ;
 
                       LDA.W wPixelsToWalkToStairs          ;00AC89|AD1D06  |00061D;
                       BEQ CODE_00AC97                      ;00AC8C|F009    |00AC97;
                       DEC.W wPixelsToWalkToStairs          ;00AC8E|CE1D06  |00061D;
                       db $20                               ;00AC91|        |      ;
          ...
          CODE_00AC97: LDA.B #$0A                           ;00AC97|A90A    |      ;
                       STA.W wPlayerStateDoubled            ;00AC99|8D6505  |000565;
                       RTS                                  ;00AC9C|60      |      ;
 
                       LDA.W wEntityPhase                   ;00AC9D|ADC105  |0005C1;
          ...
          CODE_00ACA5: JMP.W DATA8_00AD33                   ;00ACA5|4C33AD  |00AD33;
                       ...
                       LDA.B wJoy1ButtonsPressed            ;00ACA8|A528    |000028;
                       LSR A                                ;00ACAA|4A      |      ;
          ...
          CODE_00ACBA: LDA.B #$00                           ;00ACBA|A900    |      ;
                       STA.W wEntityFacingLeft              ;00ACBC|8DA804  |0004A8;
 
                       LDA.W wEntityAI_idx                  ;00ACBF|ADEF05  |0005EF;
          ...
          CODE_00ACD2: LDA.B #$01                           ;00ACD2|A901    |      ;
                       STA.W wEntityFacingLeft              ;00ACD4|8DA804  |0004A8;
                       LDA.W wEntityAI_idx                  ;00ACD7|ADEF05  |0005EF;
          ...
          CODE_00ACEA: JSR.W CODE_00ABCB                    ;00ACEA|20CBAB  |00ABCB;
                       LDA.W wEntityFractionalY             ;00ACED|ADDB04  |0004DB;
                       CLC                                  ;00ACF0|18      |      ;
                       ADC.W wEntityYposSubSpeed            ;00ACF1|6D3705  |000537;
                       STA.W wEntityFractionalY             ;00ACF4|8DDB04  |0004DB;
                       LDA.W wEntityYPos                    ;00ACF7|AD1C04  |00041C;
                       ADC.W wEntityYposSpeed               ;00ACFA|6D2005  |000520;
                       STA.W wEntityYPos                    ;00ACFD|8D1C04  |00041C;
                       LDA.W wPixelsToWalkToStairs          ;00AD00|AD1D06  |00061D;
                       BEQ CODE_00AD14                      ;00AD03|F00F    |00AD14;
                       DEC.W wPixelsToWalkToStairs          ;00AD05|CE1D06  |00061D;
                       LDA.W wEntityTimeUntilNextAnimation  ;00AD08|AD7C05  |00057C;
                       BEQ DATA8_00AD11                     ;00AD0B|F004    |00AD11;
                       DEC.W wEntityTimeUntilNextAnimation  ;00AD0D|CE7C05  |00057C;
                       RTS                                  ;00AD10|60      |      ;
         ...
         DATA8_00AD11: db $4C                               ;00AD11|        |      ;
          ...
          CODE_00AD14: LDA.B #$00                           ;00AD14|A900    |      ;
                       STA.W wEntityFractionalX             ;00AD16|8DC404  |0004C4;
                       STA.W wEntityFractionalY             ;00AD19|8DDB04  |0004DB;
                       JSR.W CODE_00AC46                    ;00AD1C|2046AC  |00AC46;
                       BCC CODE_00AD2D                      ;00AD1F|900C    |00AD2D;
                       STA.W $0790                          ;00AD21|8D9007  |000790;
                       STX.W wEntityYPos                    ;00AD24|8E1C04  |00041C;
                       LDA.B #$04                           ;00AD27|A904    |      ;
                       STA.W wPlayerStateDoubled            ;00AD29|8D6505  |000565;
                       RTS                                  ;00AD2C|60      |      ;
 
 
          CODE_00AD2D: LDA.B #$0C                           ;00AD2D|A90C    |      ;
                       STA.W wPlayerStateDoubled            ;00AD2F|8D6505  |000565;
                       RTS                                  ;00AD32|60      |      ;
         ...
         DATA8_00AD33: db $20                               ;00AD33|        |      ;
          ...
          CODE_00AD36: LDA.B #$0E                           ;00AD36|A90E    |      ;
                       STA.W wPlayerStateDoubled            ;00AD38|8D6505  |000565;
                       RTS                                  ;00AD3B|60      |      ;
         ...
         DATA8_00AD42: db $20                               ;00AD42|        |      ;
          ...
          CODE_00AD4A: LDA.B (wCurrNumToVramQueue),Y        ;00AD4A|B108    |000008;
                       STA.B $62                            ;00AD4C|8562    |000062;
                       INY                                  ;00AD4E|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AD4F|B108    |000008;
                       STA.B wVramQueueDest                 ;00AD51|8561    |000061;
                       INY                                  ;00AD53|C8      |      ;
                       db $20                               ;00AD54|        |      ;
                       dw CODE_0FE8B5                       ;00AD55|        |0FE8B5;
 
          CODE_00AD57: LDA.B (wCurrNumToVramQueue),Y        ;00AD57|B108    |000008;
                       ...
                       INY                                  ;00AD63|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AD64|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00AD66|850A    |00000A;
                       INY                                  ;00AD68|C8      |      ;
 
          CODE_00AD69: LDA.B (wCurrNumToVramQueue),Y        ;00AD69|B108    |000008;
                       STA.W wVramQueue,X                   ;00AD6B|9D0003  |000300;
                       INY                                  ;00AD6E|C8      |      ;
                       INX                                  ;00AD6F|E8      |      ;
                       DEC.B wCurrRoomSectionPlayerPosAndScreenAddr;00AD70|C60A    |00000A;
                       BNE CODE_00AD69                      ;00AD72|D0F5    |00AD69;
                       BEQ CODE_00AD57                      ;00AD74|F0E1    |00AD57;
 
          CODE_00AD76: INY                                  ;00AD76|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AD77|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00AD79|850A    |00000A;
                       INY                                  ;00AD7B|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00AD7C|B108    |000008;
                       INY                                  ;00AD7E|C8      |      ;
 
          CODE_00AD7F: STA.W wVramQueue,X                   ;00AD7F|9D0003  |000300;
                       INX                                  ;00AD82|E8      |      ;
                       DEC.B wCurrRoomSectionPlayerPosAndScreenAddr;00AD83|C60A    |00000A;
                       BNE CODE_00AD7F                      ;00AD85|D0F8    |00AD7F;
                       BEQ CODE_00AD57                      ;00AD87|F0CE    |00AD57;
 
          CODE_00AD89: STX.B wVramQueueNextIdxToFill        ;00AD89|861D    |00001D;
                       db $20                               ;00AD8B|        |      ;
                       dw CODE_0FED12                       ;00AD8C|        |0FED12;
                       INY                                  ;00AD8E|C8      |      ;
                       BNE CODE_00AD4A                      ;00AD8F|D0B9    |00AD4A;
 
          CODE_00AD91: STX.B wVramQueueNextIdxToFill        ;00AD91|861D    |00001D;
                       db $4C                               ;00AD93|        |      ;
        ...
        DATA16_00AE2C: dw $7BAE,$8FAE,$C7AE                 ;00AE2C|        |      ;
          ...
          CODE_00B3E3: LDA.B #$00                           ;00B3E3|A900    |      ;
                       STA.B wMusicLoaded                   ;00B3E5|8574    |000074;
                       db $4C                               ;00B3E7|        |      ;
 
                       dw UNREACH_0FE795                    ;00B3E8|        |0FE795;
                       LDA.B wMenuOptionIdxSelected         ;00B3EA|A56B    |00006B;
                       db $20                               ;00B3EC|        |      ;
         ...
         DATA8_00B413: db $20                               ;00B413|        |      ;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00B41C|E66B    |00006B;
                       RTS                                  ;00B41E|60      |      ;
          ...
          CODE_00B41F: JSR.W CODE_00B83A                    ;00B41F|203AB8  |00B83A;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00B42A|E66B    |00006B;
                       RTS                                  ;00B42C|60      |      ;
 
 
          CODE_00B42D: LDA.B #$00                           ;00B42D|A900    |      ;
                       STA.B wCurrScrollOffsetIntoRoomScreen;00B42F|8556    |000056;
 
                       LDA.B #$02                           ;00B431|A902    |      ;
                       STA.B wCurrScrollRoomScreen          ;00B433|8557    |000057;
                       RTS                                  ;00B435|60      |      ;
          ...
          CODE_00B436: JSR.W CODE_008F0B                    ;00B436|200B8F  |008F0B;
                       ...
                       LDA.W wPlayerStateDoubled            ;00B442|AD6505  |000565;
          ...
          CODE_00B44A: LDA.W wEntityObjectIdxes             ;00B44A|AD4E05  |00054E;
          ...
          CODE_00B457: STX.B wCurrNumToVramQueue            ;00B457|8608    |000008;
          ...
          CODE_00B47E: LDA.B #$00                           ;00B47E|A900    |      ;
                       STA.B wTimerDropClunk                ;00B480|85B9    |0000B9;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00B497|E66B    |00006B;
                       RTS                                  ;00B499|60      |      ;
 
 
          CODE_00B49A: LDA.W wEntityXPos                    ;00B49A|AD3804  |000438;
                       ...
                       LDA.W wEntityObjectIdxes,X           ;00B4A6|BD4E05  |00054E;
          ...
          CODE_00B4BC: JSR.W CODE_00B83A                    ;00B4BC|203AB8  |00B83A;
                       ...
                       STA.W wOamSpecIdxDoubled             ;00B4C1|8D0004  |000400;
                       JSR.W CODE_00B8A5                    ;00B4C4|20A5B8  |00B8A5;
                       LDA.B #$10                           ;00B4C7|A910    |      ;
                       STA.B wGenericStateTimer             ;00B4C9|8530    |000030;
          ...
          CODE_00B4CE: JSR.W CODE_00B83A                    ;00B4CE|203AB8  |00B83A;
                       ...
                       DEC.B wGenericStateTimer             ;00B4D4|C630    |000030;
                       BEQ CODE_00B4D9                      ;00B4D6|F001    |00B4D9;
                       RTS                                  ;00B4D8|60      |      ;
 
 
          CODE_00B4D9: LDY.B #$00                           ;00B4D9|A000    |      ;
                       STY.W wEffectSpeedSupGeneral         ;00B4DB|8C8507  |000785;
                       STY.W wPWiconGeneral                 ;00B4DE|8C8607  |000786;
 
                       INY                                  ;00B4E1|C8      |      ;
                       STY.W wEffectSpeedGeneral            ;00B4E2|8C8407  |000784;
                       STY.W $0787                          ;00B4E5|8C8707  |000787;
                       INC.B wMenuOptionIdxSelected         ;00B4E8|E66B    |00006B;
                       RTS                                  ;00B4EA|60      |      ;
          ...
          CODE_00B4FA: LDA.B #$00                           ;00B4FA|A900    |      ;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00B4FE|E66B    |00006B;
                       RTS                                  ;00B500|60      |      ;
          ...
          CODE_00B501: JSR.W CODE_00B82C                    ;00B501|202CB8  |00B82C;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00B509|E66B    |00006B;
          ...
          CODE_00B50C: JSR.W CODE_00B82C                    ;00B50C|202CB8  |00B82C;
                       ...
                       STA.B wFrameStartChrBankOverrideIdx  ;00B517|8572    |000072;
                       INC.B wMenuOptionIdxSelected         ;00B519|E66B    |00006B;
                       RTS                                  ;00B51B|60      |      ;
          ...
          CODE_00B51C: JSR.W CODE_00B82C                    ;00B51C|202CB8  |00B82C;
                       ...
                       LDA.B wFloodHight                    ;00B525|A5CA    |0000CA;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00B533|E66B    |00006B;
 
          CODE_00B535: RTS                                  ;00B535|60      |      ;
 
 
          CODE_00B536: JSR.W CODE_00B5F2                    ;00B536|20F2B5  |00B5F2;
                       LDA.W wEntityXPos                    ;00B539|AD3804  |000438;
                       ...
                       LDA.W wEntityObjectIdxes,X           ;00B545|BD4E05  |00054E;
          ...
          CODE_00B557: JSR.W CODE_00B82C                    ;00B557|202CB8  |00B82C;
                       ...
                       STA.B wCounterUntilCanShowSprBg      ;00B55C|851C    |00001C;
                       INC.B wMenuOptionIdxSelected         ;00B55E|E66B    |00006B;
                       RTS                                  ;00B560|60      |      ;
 
 
          CODE_00B561: LDA.B #$02                           ;00B561|A902    |      ;
                       STA.B wCounterUntilCanShowSprBg      ;00B563|851C    |00001C;
                       db $20                               ;00B565|        |      ;
                       dw UNREACH_0FE5CA                    ;00B566|        |0FE5CA;
                       JSR.W CODE_00B3E3                    ;00B568|20E3B3  |00B3E3;
                       LDA.B #$00                           ;00B56B|A900    |      ;
                       STA.B wBaseIRQFuncIdx                ;00B56D|853F    |00003F;
                       STA.B wIRQFuncDrawIdx                ;00B56F|856D    |00006D;
                       LDA.B #$40                           ;00B571|A940    |      ;
                       STA.B wBossHealth                    ;00B573|853D    |00003D;
                       db $20                               ;00B575|        |      ;
                       dw UNREACH_0FFB85                    ;00B576|        |0FFB85;
                       INC.B wCurrRoomSectionBlock          ;00B578|E633    |000033;
                       LDA.B #$00                           ;00B57A|A900    |      ;
                       STA.B wCurrRoomIdx                   ;00B57C|8534    |000034;
                       LDA.B #$01                           ;00B57E|A901    |      ;
                       STA.B wInGameSubstate                ;00B580|852A    |00002A;
                       RTS                                  ;00B582|60      |      ;
 
                       LDA.B wDeathDelay                    ;00B583|A5BF    |0000BF;
 
                       BNE CODE_00B5ED                      ;00B585|D066    |00B5ED;
                       LDA.B wFloodHight                    ;00B587|A5CA    |0000CA;
                       CMP.B #$32                           ;00B589|C932    |      ;
                       BCC CODE_00B599                      ;00B58B|900C    |00B599;
 
                       LDA.W wEntityYPos                    ;00B58D|AD1C04  |00041C;
                       SEC                                  ;00B590|38      |      ;
                       SBC.B #$10                           ;00B591|E910    |      ;
                       BCC CODE_00B5CD                      ;00B593|9038    |00B5CD;
 
                       CMP.B wFloodHight                    ;00B595|C5CA    |0000CA;
                       BCC CODE_00B5CD                      ;00B597|9034    |00B5CD;
 
          CODE_00B599: LDA.W wPlayerStateDoubled            ;00B599|AD6505  |000565;
                       ...
                       LDA.W wTimerBatRiverSwap             ;00B5B8|AD0206  |000602;
                       BEQ DATA8_00B5C7                     ;00B5BB|F00A    |00B5C7;
 
          CODE_00B5BD: LDA.B #$2E                           ;00B5BD|A92E    |      ;
                       STA.W wPlayerStateDoubled            ;00B5BF|8D6505  |000565;
                       LDA.B #$80                           ;00B5C2|A980    |      ;
                       STA.B wDeathDelay                    ;00B5C4|85BF    |0000BF;
                       RTS                                  ;00B5C6|60      |      ;
         ...
         DATA8_00B5C7: db $20                               ;00B5C7|        |      ;
          ...
          CODE_00B5CD: LDA.B wFloodStop                     ;00B5CD|A5C0    |0000C0;
                       BNE CODE_00B5ED                      ;00B5CF|D01C    |00B5ED;
                       LDA.W wHardMode                      ;00B5D1|ADF607  |0007F6;
          ...
          CODE_00B5E0: STA.B wDoubleCurrRoomIdx             ;00B5E0|850E    |00000E;
                       LDA.B $CB                            ;00B5E2|A5CB    |0000CB;
                       SEC                                  ;00B5E4|38      |      ;
                       SBC.B wDoubleCurrRoomIdx             ;00B5E5|E50E    |00000E;
                       STA.B $CB                            ;00B5E7|85CB    |0000CB;
                       BCS CODE_00B5ED                      ;00B5E9|B002    |00B5ED;
                       DEC.B wFloodHight                    ;00B5EB|C6CA    |0000CA;
 
          CODE_00B5ED: LDA.B wFloodHight                    ;00B5ED|A5CA    |0000CA;
                       STA.B wScannlineTarget               ;00B5EF|8542    |000042;
                       RTS                                  ;00B5F1|60      |      ;
          ...
          CODE_00B5F8: LDA.B wVramQueueNextIdxToFill        ;00B5F8|A51D    |00001D;
                       PHA                                  ;00B5FA|48      |      ;
                       JSR.W CODE_00852C                    ;00B5FB|202C85  |00852C;
                       PLA                                  ;00B5FE|68      |      ;
                       TAX                                  ;00B5FF|AA      |      ;
                       LDA.W wPWiconGeneral                 ;00B600|AD8607  |000786;
                       ASL A                                ;00B603|0A      |      ;
                       CLC                                  ;00B604|18      |      ;
                       ADC.W wPWiconGeneral                 ;00B605|6D8607  |000786;
          ...
          CODE_00B608: TAY                                  ;00B608|A8      |      ;
                       ...
                       INC.W wPWiconGeneral                 ;00B61F|EE8607  |000786;
          ...
          CODE_00B628: LDA.B #$00                           ;00B628|A900    |      ;
                       STA.W wPWiconGeneral                 ;00B62A|8D8607  |000786;
         ...
         DATA8_00B631: db $20,$01,$31,$11,$01               ;00B631|        |      ;
          ...
          CODE_00B64B: STA.B $03                            ;00B64B|8503    |000003;
                       ...
                       STA.B wVramQueueDest                 ;00B655|8561    |000061;
                       LDA.W DATA8_00B6E2,Y                 ;00B657|B9E2B6  |00B6E2;
                       STA.B wRoomSectionChrBanksDataOffset ;00B65A|850F    |00000F;
 
                       LDA.W DATA8_00B6E3,Y                 ;00B65C|B9E3B6  |00B6E3;
                       STA.B wDoubleCurrRoomIdx             ;00B65F|850E    |00000E;
          ...
          CODE_00B67A: LDA.B $02                            ;00B67A|A502    |000002;
                       ...
                       STA.B wCurrNumToVramQueue            ;00B681|8508    |000008;
         ...
         DATA8_00B6A2: db $20                               ;00B6A2|        |      ;
          ...
          CODE_00B6A9: LDA.B (wCurrNumToVramQueue),Y        ;00B6A9|B108    |000008;
                       db $20                               ;00B6AB|        |      ;
                       ...
                       LDX.B wVramQueueNextIdxToFill        ;00B6BE|A61D    |00001D;
                       LDA.B wDoubleCurrRoomIdx             ;00B6C0|A50E    |00000E;
                       db $20                               ;00B6C2|        |      ;
                       dw CODE_0FED16                       ;00B6C3|        |0FED16;
                       LDA.B wRoomSectionChrBanksDataOffset ;00B6C5|A50F    |00000F;
                       db $20                               ;00B6C7|        |      ;
         ...
         DATA8_00B716: db $48                               ;00B716|        |      ;
                       ...
                       STA.W wEntityObjectIdxes,X           ;00B719|9D4E05  |00054E;
                       PLA                                  ;00B71C|68      |      ;
 
          CODE_00B71D: STA.W wBGanimationTimer              ;00B71D|8D8107  |000781;
                       LDY.B #$00                           ;00B720|A000    |      ;
                       STY.W wFogParallelPos                ;00B722|8C8207  |000782;
                       INY                                  ;00B725|C8      |      ;
                       STY.W wSoundModeSongSelected         ;00B726|8C8007  |000780;
                       RTS                                  ;00B729|60      |      ;
 
 
          CODE_00B72A: LDA.W $0783                          ;00B72A|AD8307  |000783;
                       STA.B wJoy1ButtonsPressed            ;00B72D|8528    |000028;
 
                       STA.B wJoy1NewButtonsPressed         ;00B72F|8526    |000026;
 
                       DEC.W wSoundModeSongSelected         ;00B731|CE8007  |000780;
 
                       BEQ CODE_00B737                      ;00B734|F001    |00B737;
                       RTS                                  ;00B736|60      |      ;
 
 
          CODE_00B737: LDA.W wBGanimationTimer              ;00B737|AD8107  |000781;
                       ASL A                                ;00B73A|0A      |      ;
                       TAY                                  ;00B73B|A8      |      ;
                       LDA.W DATA16_00B771,Y                ;00B73C|B971B7  |00B771;
                       STA.B wCurrNumToVramQueue            ;00B73F|8508    |000008;
                       LDA.W PTR16_00B772,Y                 ;00B741|B972B7  |00B772;
                       STA.B $09                            ;00B744|8509    |000009;
                       LDA.W wFogParallelPos                ;00B746|AD8207  |000782;
                       ASL A                                ;00B749|0A      |      ;
                       TAY                                  ;00B74A|A8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00B74B|B108    |000008;
                       STA.W $0783                          ;00B74D|8D8307  |000783;
                       INY                                  ;00B750|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00B751|B108    |000008;
                       STA.W wSoundModeSongSelected         ;00B753|8D8007  |000780;
                       INC.W wFogParallelPos                ;00B756|EE8207  |000782;
                       RTS                                  ;00B759|60      |      ;
        ...
        DATA16_00B76E: dw $70E4,$8107                       ;00B76E|        |      ;
         ...
         PTR16_00B772: dw DATA8_0083B7                      ;00B772|        |0083B7;
                       ...
                       STA.B wCurrNumToVramQueue            ;00B7A2|8508    |000008;
          ...
          CODE_00B7B0: LDY.B #$00                           ;00B7B0|A000    |      ;
                       ...
                       STA.B wCurrNumToVramQueue            ;00B7B5|8508    |000008;
          ...
          CODE_00B7C9: LDA.B #$00                           ;00B7C9|A900    |      ;
                       STA.W wEntityOamSpecGroupDoubled,X   ;00B7CB|9D8C04  |00048C;
                       LDA.B #$00                           ;00B7CE|A900    |      ;
                       STA.W wOamSpecIdxDoubled,X           ;00B7D0|9D0004  |000400;
                       LDA.B #$00                           ;00B7D3|A900    |      ;
                       STA.W wEntityPaletteOverride,X       ;00B7D5|9D5404  |000454;
                       STA.W wEntityState,X                 ;00B7D8|9D7004  |000470;
                       LDA.B (wCurrNumToVramQueue),Y        ;00B7DB|B108    |000008;
                       STA.W wEntityXPos,X                  ;00B7DD|9D3804  |000438;
                       INY                                  ;00B7E0|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00B7E1|B108    |000008;
 
                       STA.W wEntityYPos,X                  ;00B7E3|9D1C04  |00041C;
                       INY                                  ;00B7E6|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00B7E7|B108    |000008;
                       STA.W wEntityObjectIdxes,X           ;00B7E9|9D4E05  |00054E;
                       INY                                  ;00B7EC|C8      |      ;
                       RTS                                  ;00B7ED|60      |      ;
 
 
          CODE_00B7EE: LDA.W wPlayerStateDoubled            ;00B7EE|AD6505  |000565;
          ...
          CODE_00B7FC: LDA.W wEntityObjectIdxes,X           ;00B7FC|BD4E05  |00054E;
          ...
          CODE_00B807: LDA.W wEntityXPos,X                  ;00B807|BD3804  |000438;
                       SEC                                  ;00B80A|38      |      ;
                       SBC.W wEntityXPos                    ;00B80B|ED3804  |000438;
          ...
          CODE_00B815: CMP.B #$08                           ;00B815|C908    |      ;
                       ...
                       LDA.W wEntityYPos,X                  ;00B819|BD1C04  |00041C;
 
                       SEC                                  ;00B81C|38      |      ;
                       SBC.W wEntityYPos                    ;00B81D|ED1C04  |00041C;
          ...
          CODE_00B82C: LDA.B wGameStateLoopCounter          ;00B82C|A51A    |00001A;
          ...
          CODE_00B83A: LDA.B wGameStateLoopCounter          ;00B83A|A51A    |00001A;
          ...
          CODE_00B845: LDA.B wGameStateLoopCounter          ;00B845|A51A    |00001A;
                       AND.B #$02                           ;00B847|2902    |      ;
                       TAY                                  ;00B849|A8      |      ;
                       LDA.W DATA8_00B855,Y                 ;00B84A|B955B8  |00B855;
                       STA.B wCurrScrollRoomScreen          ;00B84D|8557    |000057;
                       LDA.W DATA8_00B856,Y                 ;00B84F|B956B8  |00B856;
                       STA.B wCurrScrollOffsetIntoRoomScreen;00B852|8556    |000056;
                       RTS                                  ;00B854|60      |      ;
         ...
         DATA8_00B864: db $04                               ;00B864|        |      ;
          ...
          CODE_00B865: INX                                  ;00B865|E8      |      ;
                       ...
                       DEC.W w5d8,X                         ;00B86B|DED805  |0005D8;
                       LDA.B #$40                           ;00B86E|A940    |      ;
                       CLC                                  ;00B870|18      |      ;
 
          CODE_00B871: ADC.W wEntityYposSubSpeed,X          ;00B871|7D3705  |000537;
                       STA.W wEntityYposSubSpeed,X          ;00B874|9D3705  |000537;
                       BCC CODE_00B87C                      ;00B877|9003    |00B87C;
                       INC.W wEntityYposSpeed,X             ;00B879|FE2005  |000520;
 
          CODE_00B87C: LDA.W wEntityFractionalX,X           ;00B87C|BDC404  |0004C4;
                       CLC                                  ;00B87F|18      |      ;
                       ADC.W wEntityXposSubSpeed,X          ;00B880|7D0905  |000509;
 
                       STA.W wEntityFractionalX,X           ;00B883|9DC404  |0004C4;
                       LDA.W wEntityXPos,X                  ;00B886|BD3804  |000438;
                       ADC.W wEntityXposSpeed,X             ;00B889|7DF204  |0004F2;
                       STA.W wEntityXPos,X                  ;00B88C|9D3804  |000438;
                       LDA.W wEntityFractionalY,X           ;00B88F|BDDB04  |0004DB;
                       CLC                                  ;00B892|18      |      ;
                       ADC.W wEntityYposSubSpeed,X          ;00B893|7D3705  |000537;
                       STA.W wEntityFractionalY,X           ;00B896|9DDB04  |0004DB;
                       LDA.W wEntityYPos,X                  ;00B899|BD1C04  |00041C;
                       ADC.W wEntityYposSpeed,X             ;00B89C|7D2005  |000520;
                       STA.W wEntityYPos,X                  ;00B89F|9D1C04  |00041C;
          ...
          CODE_00B8A9: LDA.B #$20                           ;00B8A9|A920    |      ;
                       STA.W w5d8,X                         ;00B8AB|9DD805  |0005D8;
                       LDA.B #$0E                           ;00B8AE|A90E    |      ;
                       STA.W wEntityOamSpecGroupDoubled,X   ;00B8B0|9D8C04  |00048C;
                       LDA.B #$18                           ;00B8B3|A918    |      ;
                       STA.W wOamSpecIdxDoubled,X           ;00B8B5|9D0004  |000400;
 
                       LDA.B #$00                           ;00B8B8|A900    |      ;
                       STA.W wEntityPaletteOverride,X       ;00B8BA|9D5404  |000454;
                       STA.W wEntityState,X                 ;00B8BD|9D7004  |000470;
                       LDA.W DATA8_00B8F0,Y                 ;00B8C0|B9F0B8  |00B8F0;
                       STA.W wEntityXposSpeed,X             ;00B8C3|9DF204  |0004F2;
                       INY                                  ;00B8C6|C8      |      ;
                       LDA.W DATA8_00B8F0,Y                 ;00B8C7|B9F0B8  |00B8F0;
                       STA.W wEntityXposSubSpeed,X          ;00B8CA|9D0905  |000509;
                       INY                                  ;00B8CD|C8      |      ;
                       LDA.W DATA8_00B8F0,Y                 ;00B8CE|B9F0B8  |00B8F0;
 
                       STA.W wEntityYposSpeed,X             ;00B8D1|9D2005  |000520;
                       INY                                  ;00B8D4|C8      |      ;
                       LDA.W DATA8_00B8F0,Y                 ;00B8D5|B9F0B8  |00B8F0;
                       STA.W wEntityYposSubSpeed,X          ;00B8D8|9D3705  |000537;
                       INY                                  ;00B8DB|C8      |      ;
 
                       LDA.W DATA8_00B8F0,Y                 ;00B8DC|B9F0B8  |00B8F0;
                       STA.W wEntityXPos,X                  ;00B8DF|9D3804  |000438;
                       INY                                  ;00B8E2|C8      |      ;
                       LDA.W DATA8_00B8F0,Y                 ;00B8E3|B9F0B8  |00B8F0;
                       STA.W wEntityYPos,X                  ;00B8E6|9D1C04  |00041C;
                       INY                                  ;00B8E9|C8      |      ;
                       INX                                  ;00B8EA|E8      |      ;
         ...
         DATA8_00B8F0: db $FF,$80,$00,$C0,$80               ;00B8F0|        |      ;
          ...
          CODE_00B90E: DEC.W wEffectSpeedGeneral            ;00B90E|CE8407  |000784;
          ...
          CODE_00B915: JSR.W CODE_00B990                    ;00B915|2090B9  |00B990;
                       ...
                       INC.W wEffectSpeedSupGeneral         ;00B91B|EE8507  |000785;
                       LDA.W wEffectSpeedSupGeneral         ;00B91E|AD8507  |000785;
                       CMP.B #$0C                           ;00B921|C90C    |      ;
                       BEQ CODE_00B92C                      ;00B923|F007    |00B92C;
                       LDA.B #$06                           ;00B925|A906    |      ;
                       STA.W wEffectSpeedGeneral            ;00B927|8D8407  |000784;
                       CLC                                  ;00B92A|18      |      ;
                       RTS                                  ;00B92B|60      |      ;
          ...
          CODE_00B92E: LDA.W wEffectSpeedSupGeneral         ;00B92E|AD8507  |000785;
                       ASL A                                ;00B931|0A      |      ;
                       TAY                                  ;00B932|A8      |      ;
                       LDA.W DATA8_00BA12,Y                 ;00B933|B912BA  |00BA12;
                       STA.B $62                            ;00B936|8562    |000062;
                       LDA.W DATA8_00BA13,Y                 ;00B938|B913BA  |00BA13;
                       STA.B wVramQueueDest                 ;00B93B|8561    |000061;
                       db $20                               ;00B93D|        |      ;
                       dw CODE_0FE8B5                       ;00B93E|        |0FE8B5;
                       LDY.W wEffectSpeedSupGeneral         ;00B940|AC8507  |000785;
                       ...
                       STA.B wCurrNumToVramQueue            ;00B955|8508    |000008;
                       ...
                       STA.B wCurrNumToVramQueue            ;00B966|8508    |000008;
          ...
          CODE_00B977: LDY.W wEffectSpeedSupGeneral         ;00B977|AC8507  |000785;
          ...
          CODE_00B980: ASL A                                ;00B980|0A      |      ;
                       TAY                                  ;00B981|A8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00B982|B108    |000008;
 
                       AND.B $01                            ;00B984|2501    |000001;
                       INY                                  ;00B986|C8      |      ;
                       ORA.B (wCurrNumToVramQueue),Y        ;00B987|1108    |000008;
                       STA.W wVramQueue,X                   ;00B989|9D0003  |000300;
                       INX                                  ;00B98C|E8      |      ;
                       STX.B wVramQueueNextIdxToFill        ;00B98D|861D    |00001D;
                       RTS                                  ;00B98F|60      |      ;
 
 
          CODE_00B990: LDA.W wEffectSpeedSupGeneral         ;00B990|AD8507  |000785;
                       ASL A                                ;00B993|0A      |      ;
                       TAY                                  ;00B994|A8      |      ;
                       LDA.W DATA8_00B9FA,Y                 ;00B995|B9FAB9  |00B9FA;
                       STA.B $62                            ;00B998|8562    |000062;
                       LDA.W DATA8_00B9FB,Y                 ;00B99A|B9FBB9  |00B9FB;
                       STA.B wVramQueueDest                 ;00B99D|8561    |000061;
                       db $20                               ;00B99F|        |      ;
                       dw CODE_0FE8B5                       ;00B9A0|        |0FE8B5;
                       LDA.W wEffectSpeedSupGeneral         ;00B9A2|AD8507  |000785;
          ...
          CODE_00B9B9: LDA.W DATA8_00B9E0,Y                 ;00B9B9|B9E0B9  |00B9E0;
                       ...
                       STA.W wVramQueue,X                   ;00B9C0|9D0003  |000300;
                       INY                                  ;00B9C3|C8      |      ;
                       INX                                  ;00B9C4|E8      |      ;
                       ...
                       CLC                                  ;00B9CE|18      |      ;
                       ADC.B wVramQueueDest                 ;00B9CF|6561    |000061;
                       STA.B wVramQueueDest                 ;00B9D1|8561    |000061;
         ...
         DATA8_00BA3B: db $A0,$2A,$8A,$BB,$E0               ;00BA3B|        |      ;
                       ...
                       db $00                               ;00BA45|        |      ;
                       LDA.B wMenuOptionIdxSelected         ;00BA46|A56B    |00006B;
          ...
          CODE_00BA51: LDA.B #$00                           ;00BA51|A900    |      ;
                       STA.W wPWdumpGeneral                 ;00BA53|8D8807  |000788;
                       INC.B wMenuOptionIdxSelected         ;00BA56|E66B    |00006B;
                       RTS                                  ;00BA58|60      |      ;
 
 
          CODE_00BA59: LDA.B wGameStateLoopCounter          ;00BA59|A51A    |00001A;
                       AND.B #$03                           ;00BA5B|2903    |      ;
                       BEQ CODE_00BA60                      ;00BA5D|F001    |00BA60;
                       RTS                                  ;00BA5F|60      |      ;
 
 
          CODE_00BA60: LDY.W wPWdumpGeneral                 ;00BA60|AC8807  |000788;
                       ...
                       INC.W wPWdumpGeneral                 ;00BA6E|EE8807  |000788;
                       LDA.W wPWdumpGeneral                 ;00BA71|AD8807  |000788;
                       CMP.B #$04                           ;00BA74|C904    |      ;
                       BNE CODE_00BA7A                      ;00BA76|D002    |00BA7A;
                       INC.B wMenuOptionIdxSelected         ;00BA78|E66B    |00006B;
         ...
         DATA8_00BA7F: db $20,$95,$BA                       ;00BA7F|        |      ;
                       LDA.B wCurrentRoomEffect             ;00BA82|A57D    |00007D;
          ...
          CODE_00BA8E: STA.B wBaseIRQFuncIdx                ;00BA8E|853F    |00003F;
                       LDA.B #$03                           ;00BA90|A903    |      ;
                       STA.B wInGameSubstate                ;00BA92|852A    |00002A;
                       RTS                                  ;00BA94|60      |      ;
 
                       JSR.W CODE_00BDDA                    ;00BA95|20DABD  |00BDDA;
                       LDY.B #$00                           ;00BA98|A000    |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BA9A|B108    |000008;
                       ASL A                                ;00BA9C|0A      |      ;
                       SEC                                  ;00BA9D|38      |      ;
                       SBC.B #$02                           ;00BA9E|E902    |      ;
                       STA.B wDoubleCurrGroup               ;00BAA0|850C    |00000C;
                       LDY.B #$01                           ;00BAA2|A001    |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BAA4|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00BAA6|850A    |00000A;
                       INY                                  ;00BAA8|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BAA9|B108    |000008;
                       STA.B $0B                            ;00BAAB|850B    |00000B;
                       JSR.W CODE_00BAC2                    ;00BAAD|20C2BA  |00BAC2;
                       LDA.B wDoubleCurrGroup               ;00BAB0|A50C    |00000C;
                       CLC                                  ;00BAB2|18      |      ;
                       ADC.B #$02                           ;00BAB3|6902    |      ;
                       STA.B wDoubleCurrGroup               ;00BAB5|850C    |00000C;
                       LDY.B #$03                           ;00BAB7|A003    |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BAB9|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00BABB|850A    |00000A;
                       INY                                  ;00BABD|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BABE|B108    |000008;
                       STA.B $0B                            ;00BAC0|850B    |00000B;
 
          CODE_00BAC2: LDY.B $59                            ;00BAC2|A459    |000059;
                       STY.B wRoomSectionChrBanksDataOffset ;00BAC4|840F    |00000F;
                       LDA.B #$0C                           ;00BAC6|A90C    |      ;
                       STA.B $00                            ;00BAC8|8500    |000000;
 
          CODE_00BACA: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BACA|B10A    |00000A;
          ...
          CODE_00BADC: LDY.B wRoomSectionChrBanksDataOffset ;00BADC|A40F    |00000F;
                       INY                                  ;00BADE|C8      |      ;
                       STY.B wRoomSectionChrBanksDataOffset ;00BADF|840F    |00000F;
          ...
          CODE_00BAF0: JSR.W CODE_00BB07                    ;00BAF0|2007BB  |00BB07;
                       ...
                       STA.W wCurrCollisionMapValues90,Y    ;00BAF5|99E006  |0006E0;
                       BEQ CODE_00BADC                      ;00BAF8|F0E2    |00BADC;
 
          CODE_00BAFA: JSR.W CODE_00BB07                    ;00BAFA|2007BB  |00BB07;
                       LDA.B #$00                           ;00BAFD|A900    |      ;
                       STA.W wCurrCollisionMapValues90,Y    ;00BAFF|99E006  |0006E0;
          ...
          CODE_00BB11: TAY                                  ;00BB11|A8      |      ;
                       ...
                       CLC                                  ;00BB15|18      |      ;
                       ADC.B wDoubleCurrGroup               ;00BB16|650C    |00000C;
                       TAY                                  ;00BB18|A8      |      ;
                       RTS                                  ;00BB19|60      |      ;
                       ...
                       LDA.W wEntityXPos                    ;00BB2C|AD3804  |000438;
                       CLC                                  ;00BB2F|18      |      ;
                       ADC.B wCurrScrollOffsetIntoRoomScreen;00BB30|6556    |000056;
                       STA.B $00                            ;00BB32|8500    |000000;
                       LDA.B #$00                           ;00BB34|A900    |      ;
                       ADC.B wCurrScrollRoomScreen          ;00BB36|6557    |000057;
                       LSR A                                ;00BB38|4A      |      ;
                       ...
                       STA.W wFogParallelPos                ;00BB46|8D8207  |000782;
                       STA.W wEffectSpeedGeneral            ;00BB49|8D8407  |000784;
 
                       STA.W wPWiconGeneral                 ;00BB4C|8D8607  |000786;
                       LDA.W wEntityYPos                    ;00BB4F|AD1C04  |00041C;
                       LSR A                                ;00BB52|4A      |      ;
                       LSR A                                ;00BB53|4A      |      ;
                       LSR A                                ;00BB54|4A      |      ;
                       ...
                       STA.W wEffectSpeedSupGeneral         ;00BB5A|8D8507  |000785;
                       STA.W $0787                          ;00BB5D|8D8707  |000787;
                       LDA.B #$0C                           ;00BB60|A90C    |      ;
                       STA.W wPWdumpGeneral                 ;00BB62|8D8807  |000788;
 
                       LDA.B #$01                           ;00BB65|A901    |      ;
                       STA.B wBaseIRQFuncIdx                ;00BB67|853F    |00003F;
 
                       INC.B wMenuOptionIdxSelected         ;00BB69|E66B    |00006B;
                       RTS                                  ;00BB6B|60      |      ;
 
                       LDA.B wGameStateLoopCounter          ;00BB6C|A51A    |00001A;
                       AND.B #$01                           ;00BB6E|2901    |      ;
 
                       BEQ CODE_00BB79                      ;00BB70|F007    |00BB79;
 
                       DEC.W wPWdumpGeneral                 ;00BB72|CE8807  |000788;
                       BNE CODE_00BB7A                      ;00BB75|D003    |00BB7A;
 
                       INC.B wMenuOptionIdxSelected         ;00BB77|E66B    |00006B;
          ...
          CODE_00BB7A: JSR.W CODE_00BDE0                    ;00BB7A|20E0BD  |00BDE0;
                       ...
                       LDY.W wEffectSpeedGeneral            ;00BB82|AC8407  |000784;
                       DEY                                  ;00BB85|88      |      ;
                       TYA                                  ;00BB86|98      |      ;
                       LSR A                                ;00BB87|4A      |      ;
                       TAY                                  ;00BB88|A8      |      ;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BB89|B10A    |00000A;
                       ...
                       LDA.W wEffectSpeedSupGeneral         ;00BB99|AD8507  |000785;
                       SEC                                  ;00BB9C|38      |      ;
                       SBC.B (wCurrNumToVramQueue),Y        ;00BB9D|F108    |000008;
                       BNE CODE_00BBA6                      ;00BB9F|D005    |00BBA6;
                       INC.W wEffectSpeedSupGeneral         ;00BBA1|EE8507  |000785;
                       BNE CODE_00BBAE                      ;00BBA4|D008    |00BBAE;
 
          CODE_00BBA6: DEC.W wEffectSpeedSupGeneral         ;00BBA6|CE8507  |000785;
                       BNE CODE_00BBAE                      ;00BBA9|D003    |00BBAE;
 
          CODE_00BBAB: DEC.W wEffectSpeedGeneral            ;00BBAB|CE8407  |000784;
 
          CODE_00BBAE: LDX.B #$02                           ;00BBAE|A202    |      ;
                       JSR.W CODE_00BBDE                    ;00BBB0|20DEBB  |00BBDE;
 
                       LDY.W wPWiconGeneral                 ;00BBB3|AC8607  |000786;
                       INY                                  ;00BBB6|C8      |      ;
                       TYA                                  ;00BBB7|98      |      ;
                       LSR A                                ;00BBB8|4A      |      ;
                       TAY                                  ;00BBB9|A8      |      ;
 
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BBBA|B10A    |00000A;
          ...
          CODE_00BBBE: BEQ CODE_00BBDA                      ;00BBBE|F01A    |00BBDA;
                       ...
                       SEC                                  ;00BBCD|38      |      ;
                       SBC.B (wCurrNumToVramQueue),Y        ;00BBCE|F108    |000008;
          ...
          CODE_00BBDA: INC.W wPWiconGeneral                 ;00BBDA|EE8607  |000786;
                       RTS                                  ;00BBDD|60      |      ;
 
 
          CODE_00BBDE: STX.B wRoomSectionChrBanksDataOffset ;00BBDE|860F    |00000F;
                       LDY.B #$00                           ;00BBE0|A000    |      ;
                       LDA.W wEffectSpeedSupGeneral,X       ;00BBE2|BD8507  |000785;
                       SEC                                  ;00BBE5|38      |      ;
                       SBC.B (wCurrNumToVramQueue),Y        ;00BBE6|F108    |000008;
                       ASL A                                ;00BBE8|0A      |      ;
                       TAY                                  ;00BBE9|A8      |      ;
                       INY                                  ;00BBEA|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BBEB|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00BBED|850A    |00000A;
                       INY                                  ;00BBEF|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BBF0|B108    |000008;
                       STA.B $0B                            ;00BBF2|850B    |00000B;
                       LDA.W wEffectSpeedGeneral,X          ;00BBF4|BD8407  |000784;
                       LSR A                                ;00BBF7|4A      |      ;
                       BCS CODE_00BC31                      ;00BBF8|B037    |00BC31;
                       TAY                                  ;00BBFA|A8      |      ;
                       LDA.B wRoomSectionChrBanksDataOffset ;00BBFB|A50F    |00000F;
                       BEQ CODE_00BC18                      ;00BBFD|F019    |00BC18;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BBFF|B10A    |00000A;
          ...
          CODE_00BC18: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BC18|B10A    |00000A;
          ...
          CODE_00BC31: TAY                                  ;00BC31|A8      |      ;
                       LDA.B wRoomSectionChrBanksDataOffset ;00BC32|A50F    |00000F;
                       BEQ CODE_00BC4F                      ;00BC34|F019    |00BC4F;
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BC36|B10A    |00000A;
          ...
          CODE_00BC4F: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BC4F|B10A    |00000A;
          ...
          CODE_00BC65: STA.B $00                            ;00BC65|8500    |000000;
                       ...
                       STA.B wVramQueueDest                 ;00BC6C|8561    |000061;
                       LDA.W wEffectSpeedSupGeneral,X       ;00BC6E|BD8507  |000785;
                       ASL A                                ;00BC71|0A      |      ;
                       ASL A                                ;00BC72|0A      |      ;
                       ASL A                                ;00BC73|0A      |      ;
                       CLC                                  ;00BC74|18      |      ;
                       ADC.B wVramQueueDest                 ;00BC75|6561    |000061;
                       CLC                                  ;00BC77|18      |      ;
                       ADC.B #$C0                           ;00BC78|69C0    |      ;
                       STA.B wVramQueueDest                 ;00BC7A|8561    |000061;
          ...
          CODE_00BC93: STA.B $62                            ;00BC93|8562    |000062;
                       ...
                       STA.W wVramQueue,X                   ;00BC9A|9D0003  |000300;
                       INX                                  ;00BC9D|E8      |      ;
                       STX.B wVramQueueNextIdxToFill        ;00BC9E|861D    |00001D;
                       db $20                               ;00BCA0|        |      ;
 
                       dw CODE_0FED12                       ;00BCA1|        |0FED12;
                       LDA.B #$02                           ;00BCA3|A902    |      ;
                       STA.B $01                            ;00BCA5|8501    |000001;
                       LDX.B wRoomSectionChrBanksDataOffset ;00BCA7|A60F    |00000F;
                       LDA.W wEffectSpeedSupGeneral,X       ;00BCA9|BD8507  |000785;
                       ASL A                                ;00BCAC|0A      |      ;
                       SEC                                  ;00BCAD|38      |      ;
                       SBC.B #$02                           ;00BCAE|E902    |      ;
                       STA.B $00                            ;00BCB0|8500    |000000;
                       LDA.B wCurrentRoomEffect             ;00BCB2|A57D    |00007D;
                       AND.B #$0F                           ;00BCB4|290F    |      ;
                       BEQ CODE_00BCC0                      ;00BCB6|F008    |00BCC0;
                       LDA.W wEntityYPos                    ;00BCB8|AD1C04  |00041C;
                       BPL CODE_00BCC0                      ;00BCBB|1003    |00BCC0;
                       CLC                                  ;00BCBD|18      |      ;
 
                       INC.B $00                            ;00BCBE|E600    |000000;
 
          CODE_00BCC0: LDA.W wEffectSpeedGeneral,X          ;00BCC0|BD8407  |000784;
                       ...
                       LSR A                                ;00BCC6|4A      |      ;
                       TAY                                  ;00BCC7|A8      |      ;
                       LDA.W wEffectSpeedGeneral,X          ;00BCC8|BD8407  |000784;
          ...
          CODE_00BCDA: TAY                                  ;00BCDA|A8      |      ;
                       ...
                       STA.W wCurrCollisionMapValues90,Y    ;00BCE4|99E006  |0006E0;
                       RTS                                  ;00BCE7|60      |      ;
                       ...
                       INC.B wMenuOptionIdxSelected         ;00BCF2|E66B    |00006B;
                       RTS                                  ;00BCF4|60      |      ;
 
 
          CODE_00BCF5: JSR.W CODE_00BDDA                    ;00BCF5|20DABD  |00BDDA;
                       LDY.B #$00                           ;00BCF8|A000    |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BCFA|B108    |000008;
                       ASL A                                ;00BCFC|0A      |      ;
                       ASL A                                ;00BCFD|0A      |      ;
                       ASL A                                ;00BCFE|0A      |      ;
                       CLC                                  ;00BCFF|18      |      ;
                       ADC.B #$C0                           ;00BD00|69C0    |      ;
                       STA.B wVramQueueDest                 ;00BD02|8561    |000061;
                       LDA.B wCurrScrollOffsetIntoRoomScreen;00BD04|A556    |000056;
                       STA.B wDoubleCurrGroup               ;00BD06|850C    |00000C;
                       LDA.B wCurrScrollRoomScreen          ;00BD08|A557    |000057;
                       LSR A                                ;00BD0A|4A      |      ;
                       ROR.B wDoubleCurrGroup               ;00BD0B|660C    |00000C;
                       LSR A                                ;00BD0D|4A      |      ;
                       ROR.B wDoubleCurrGroup               ;00BD0E|660C    |00000C;
                       LSR A                                ;00BD10|4A      |      ;
                       ROR.B wDoubleCurrGroup               ;00BD11|660C    |00000C;
                       LSR A                                ;00BD13|4A      |      ;
                       ROR.B wDoubleCurrGroup               ;00BD14|660C    |00000C;
                       LSR A                                ;00BD16|4A      |      ;
                       ROR.B wDoubleCurrGroup               ;00BD17|660C    |00000C;
                       LDA.B wDoubleCurrGroup               ;00BD19|A50C    |00000C;
                       SEC                                  ;00BD1B|38      |      ;
                       SBC.B #$02                           ;00BD1C|E902    |      ;
                       BPL CODE_00BD22                      ;00BD1E|1002    |00BD22;
                       LDA.B #$00                           ;00BD20|A900    |      ;
 
          CODE_00BD22: STA.B wDoubleCurrGroup               ;00BD22|850C    |00000C;
                       ...
                       LDA.B wDoubleCurrGroup               ;00BD2D|A50C    |00000C;
                       AND.B #$07                           ;00BD2F|2907    |      ;
                       STA.B $02                            ;00BD31|8502    |000002;
                       LDA.B wDoubleCurrGroup               ;00BD33|A50C    |00000C;
          ...
          CODE_00BD41: STA.B $62                            ;00BD41|8562    |000062;
                       ...
                       CLC                                  ;00BD47|18      |      ;
                       ADC.B wVramQueueDest                 ;00BD48|6561    |000061;
                       STA.B wVramQueueDest                 ;00BD4A|8561    |000061;
                       STA.B $05                            ;00BD4C|8505    |000005;
                       LDY.B #$01                           ;00BD4E|A001    |      ;
 
                       LDA.B (wCurrNumToVramQueue),Y        ;00BD50|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00BD52|850A    |00000A;
                       INY                                  ;00BD54|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BD55|B108    |000008;
                       ...
                       STA.B wVramQueueDest                 ;00BD65|8561    |000061;
                       LDY.B #$03                           ;00BD67|A003    |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BD69|B108    |000008;
                       STA.B wCurrRoomSectionPlayerPosAndScreenAddr;00BD6B|850A    |00000A;
                       INY                                  ;00BD6D|C8      |      ;
                       LDA.B (wCurrNumToVramQueue),Y        ;00BD6E|B108    |000008;
                       STA.B $0B                            ;00BD70|850B    |00000B;
                       JSR.W CODE_00BD86                    ;00BD72|2086BD  |00BD86;
                       LDA.W wPlayerStateDoubled            ;00BD75|AD6505  |000565;
                       AND.B #$7F                           ;00BD78|297F    |      ;
                       STA.W wPlayerStateDoubled            ;00BD7A|8D6505  |000565;
                       LDA.B #$68                           ;00BD7D|A968    |      ;
                       STA.B $C7                            ;00BD7F|85C7    |0000C7;
                       LDA.B #$1B                           ;00BD81|A91B    |      ;
                       STA.B wInGameSubstate                ;00BD83|852A    |00002A;
                       RTS                                  ;00BD85|60      |      ;
 
 
          CODE_00BD86: LDY.B wDoubleCurrGroup               ;00BD86|A40C    |00000C;
                       LDA.B #$0C                           ;00BD88|A90C    |      ;
                       STA.B wRoomSectionChrBanksDataOffset ;00BD8A|850F    |00000F;
 
          CODE_00BD8C: LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BD8C|B10A    |00000A;
          ...
          CODE_00BD9E: DEC.B wRoomSectionChrBanksDataOffset ;00BD9E|C60F    |00000F;
                       BEQ CODE_00BDC5                      ;00BDA0|F023    |00BDC5;
                       LDA.B wVramQueueDest                 ;00BDA2|A561    |000061;
                       AND.B #$08                           ;00BDA4|2908    |      ;
                       STA.B $01                            ;00BDA6|8501    |000001;
                       INC.B wVramQueueDest                 ;00BDA8|E661    |000061;
                       LDA.B wVramQueueDest                 ;00BDAA|A561    |000061;
          ...
          CODE_00BDB5: LDA.B wVramQueueDest                 ;00BDB5|A561    |000061;
                       SEC                                  ;00BDB7|38      |      ;
                       SBC.B #$08                           ;00BDB8|E908    |      ;
                       STA.B wVramQueueDest                 ;00BDBA|8561    |000061;
         ...
         DATA8_00BDC6: db $20                               ;00BDC6|        |      ;
                       ...
                       LDA.B (wCurrRoomSectionPlayerPosAndScreenAddr),Y;00BDC9|B10A    |00000A;
                       STA.W wVramQueue,X                   ;00BDCB|9D0003  |000300;
                       INX                                  ;00BDCE|E8      |      ;
                       LDA.B #$FF                           ;00BDCF|A9FF    |      ;
                       STA.W wVramQueue,X                   ;00BDD1|9D0003  |000300;
                       INX                                  ;00BDD4|E8      |      ;
                       STX.B wVramQueueNextIdxToFill        ;00BDD5|861D    |00001D;
          ...
          CODE_00BDE0: LDA.B wCurrentRoomEffect             ;00BDE0|A57D    |00007D;
                       AND.B #$0F                           ;00BDE2|290F    |      ;
                       BEQ CODE_00BDEE                      ;00BDE4|F008    |00BDEE;
                       LDY.W wEntityYPos                    ;00BDE6|AC1C04  |00041C;
          ...
          CODE_00BDF1: ASL A                                ;00BDF1|0A      |      ;
                       ...
                       STA.B wCurrNumToVramQueue            ;00BDF6|8508    |000008;
